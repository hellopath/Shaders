...
THREE.Vector2.prototype = {
    ...
    isZero: function (a) {
        return this.lengthSq() < (void 0 !== a ? a : 1E-4)
    },
    clone: function () {
...
THREE.Vector3.prototype = {
    ...
    setEulerFromRotationMatrix: function (a, b) {
        ...
        void 0 === b || "XYZ" === b ? (this.y = Math.asin(c(g)), 0.99999 > Math.abs(g) ? (this.x = Math.atan2(-j, d), this.z = Math.atan2(-f, e)) : (this.x = Math.atan2(m, i), this.z = 0)) : "YXZ" === b ? (this.x = Math.asin(-c(j)), 0.99999 > Math.abs(j) ? (this.y = Math.atan2(g, d), this.z = Math.atan2(h, i)) : (this.y = Math.atan2(-l, e), this.z = 0)) : "ZXY" === b ? (this.x = Math.asin(c(m)), 0.99999 > Math.abs(m) ? (this.y = Math.atan2(-l, d), this.z = Math.atan2(-f, i)) : (this.y = 0, this.z = Math.atan2(h, e))) : "ZYX" === b ? (this.y = Math.asin(-c(l)), 0.99999 > Math.abs(l) ? (this.x = Math.atan2(m, d), this.z = Math.atan2(h, e)) : (this.x = 0, this.z = Math.atan2(-f, i))) : "YZX" === b ? (this.z = Math.asin(c(h)), 0.99999 > Math.abs(h) ? (this.x = Math.atan2(-j, i), this.y = Math.atan2(-l, e)) : (this.x = 0, this.y = Math.atan2(g, d))) :
            "XZY" === b && (this.z = Math.asin(-c(f)), 0.99999 > Math.abs(f) ? (this.x = Math.atan2(m, i), this.y = Math.atan2(g, e)) : (this.x = Math.atan2(-j, d), this.y = 0));
        return this
    },
...
THREE.Vector4.prototype = {
    ...
    setAxisAngleFromRotationMatrix: function (a) {
        ...
        if (0.01 > Math.abs(d - g) && 0.01 > Math.abs(f - c) && 0.01 > Math.abs(i - b)) {
            ...
            f = (f + c) / 4;
            i = (i + b) / 4;
            e > h && e > j ? 0.01 > e ? (b = 0, d = c = 0.707106781) : (b = Math.sqrt(e), c = d / b, d = f / b) : h > j ? 0.01 > h ? (b = 0.707106781, c = 0, d = 0.707106781) : (c = Math.sqrt(h), b = d / c, d = i / c) : 0.01 > j ? (c = b = 0.707106781, d = 0) : (d = Math.sqrt(j), b = f / d, c = i / d);
            this.set(b, c, d, a);
            return this
        }
...
THREE.Matrix4 = function (a, b, c, d, e, f, g, h, i, j, l, m, n, p, o, q) {
    this.elements = new Float32Array(16);
    this.set(void 0 !== a ? a : 1, b || 0, c || 0, d || 0, e || 0, void 0 !== f ? f : 1, g || 0, h || 0, i || 0, j || 0, void 0 !== l ? l : 1, m || 0, n || 0, p || 0, o || 0, void 0 !== q ? q : 1)
};
THREE.Matrix4.prototype = {
    constructor: THREE.Matrix4,
    set: function (a, b, c, d, e, f, g, h, i, j, l, m, n, p, o, q) {
        var r = this.elements;
        r[0] = a;
        r[4] = b;
        r[8] = c;
    ...
    multiply: function (a, b) {
        ...
        e[4] = f * z + g * C + h * E + i * I;
        e[8] = f * A + g * G + h * M + i * L;
        e[12] = f * v + g * H + h * K + i * d;
        e[1] = j * s + l * y + m * J + n * F;
        e[5] = j * z + l * C + m * E + n * I;
        e[9] = j * A + l * G + m * M + n * L;
        e[13] = j * v + l * H + m * K + n * d;
        e[2] = p * s + o * y + q * J + r * F;
        e[6] = p * z + o * C + q * E + r * I;
        e[10] = p * A + o * G + q * M + r * L;
        e[14] = p * v + o * H + q * K + r * d;
        e[3] = t * s + B * y + u * J + c * F;
        e[7] = t * z + B * C + u * E + c * I;
        e[11] = t * A + B * G + u * M + c * L;
        e[15] = t * v + B * H + u * K + c * d;
        return this
    },
    multiplySelf: function (a) {
    ...
    determinant: function () {
        var a = this.elements,
            ...
            q = a[11],
            a = a[15];
        return e * h * l * p - d * i * l * p - e * g * m * p + c * i * m * p + d * g * n * p - c * h * n * p - e * h * j * o + d * i * j * o + e * f * m * o - b * i * m * o - d * f * n * o + b * h * n * o + e * g * j * q - c * i * j * q - e * f * l * q + b * i * l * q + c * f * n * q - b * g * n * q - d * g * j * a + c * h * j * a + d * f * l * a - b * h * l * a - c * f * m * a + b * g * m * a
    },
    transpose: function () {
        var a = this.elements,
            b;
    ...
    getInverse: function (a) {
        var b = this.elements,
            ...
            t = c[11],
            c = c[15];
        b[0] = j * o * r - l * p * r + l * n * t - i * o * t - j * n * c + i * p * c;
        b[4] = g * p * r - f * o * r - g * n * t + e * o * t + f * n * c - e * p * c;
        b[8] = f * l * r - g * j * r + g * i * t - e * l * t - f * i * c + e * j * c;
        b[12] = g * j * n - f * l * n - g * i * p + e * l * p + f * i * o - e * j * o;
        b[1] = l * p * q - j * o * q - l * m * t + h * o * t + j * m * c - h * p * c;
        b[5] = f * o * q - g * p * q + g * m * t - d * o * t - f * m * c + d * p * c;
        b[9] = g * j * q - f * l * q - g * h * t + d * l * t + f * h * c - d * j * c;
        b[13] = f * l * m - g * j * m + g * h * p - d * l * p - f * h * o + d * j * o;
        b[2] = i * o * q - l * n * q + l * m * r - h * o * r - i * m * c + h * n * c;
        b[6] = g * n * q - e * o * q - g * m * r + d * o * r + e * m * c - d * n * c;
        b[10] = e * l * q - g * i * q + g * h * r - d * l * r - e * h * c + d * i * c;
        b[14] = g * i * m - e * l * m - g * h * n + d * l * n + e * h * o - d * i * o;
        b[3] = j * n * q - i * p * q - j * m * r + h * p * r + i * m * t - h * n * t;
        b[7] = e * p * q - f * n * q + f * m * r - d * p * r - e * m * t + d * n * t;
        b[11] = f * i * q - e * j * q - f * h * r + d * j * r + e * h * t - d * i * t;
...
THREE.Frustum.prototype.setFromMatrix = function (a) {
    ...
    b[2].set(f + d, j + h, p + m, c + q);
    b[3].set(f - d, j - h, p - m, c - q);
    b[4].set(f - e, j - i, p - n, c - r);
    b[5].set(f + e, j + i, p + n, c + r);
    for (d = 0; 6 > d; d++) a = b[d], a.divideScalar(Math.sqrt(a.x * a.x + a.y * a.y + a.z * a.z))
};
THREE.Frustum.prototype.contains = function (a) {
    for (var b = 0, c = this.planes, b = a.matrixWorld, d = b.elements, a = -a.geometry.boundingSphere.radius * b.getMaxScaleOnAxis(), e = 0; 6 > e; e++) if (b = c[e].x * d[12] + c[e].y * d[13] + c[e].z * d[14] + c[e].w, b <= a) return !1;
    return !0
};
...
(function (a) {
    ...
    var b = new a.Vector3,
        ...
        n = function (a, b, c) {
            j.sub(c, a);
            var d = j.dot(b),
                a = l.add(a, m.copy(b).multiplyScalar(d));
            ...
            if (i instanceof a.Particle) {
                m = n(l.origin, l.direction, i.matrixWorld.getPosition());
                if (m > i.scale.x) return j;
                o = {
                    distance: m,
                    point: i.position,
                    face: null,
                ...
                var q = i.geometry.boundingSphere.radius * i.matrixWorld.getMaxScaleOnAxis();
                m = n(l.origin, l.direction, i.matrixWorld.getPosition());
                if (m > q) return j;
                var A,
                v, y = i.geometry,
                    C = y.vertices,
                    G, H, J;
                G = i.geometry.materials;
                H = i.material instanceof a.MeshFaceMaterial;
                var E, M = l.precision;
                ...
                q = 0;
                for (A = y.faces.length; q < A; q++) if (o = y.faces[q], m = !0 === H ? G[o.materialIndex] : i.material, void 0 !== m && (J = m.side, e.sub(o.centroid, c), f = o.normal, m = d.dot(f), !(Math.abs(m) < M) && (v = f.dot(e) / m, !(0 > v) && (J === a.DoubleSide || (J === a.FrontSide ? 0 > m : 0 < m))))) if (g.add(c, d.multiplyScalar(v)), o instanceof a.Face3) m = C[o.a], v = C[o.b], J = C[o.c], p(g, m, v, J) && (v = i.matrixWorld.multiplyVector3(g.clone()), m = b.distanceTo(v), m < l.near || m > l.far || (o = {
                    distance: m,
                    point: v,
                    face: o,
                    faceIndex: q,
                ...
                else if (o instanceof a.Face4 && (m = C[o.a], v = C[o.b], J = C[o.c], E = C[o.d], p(g, m, v, E) || p(g, v, J, E))) v = i.matrixWorld.multiplyVector3(g.clone()), m = b.distanceTo(v), m < l.near || m > l.far || (o = {
                    distance: m,
                    point: v,
                    face: o,
                    faceIndex: q,
        ...
        q = function (a, b, c) {
            for (var a = a.getDescendants(), d = 0, e = a.length; d < e; d++) o(a[d], b, c)
        };
    ...
    a.Ray.prototype.intersectObjects = function (a, b) {
        for (var c = [], d = 0, e = a.length; d < e; d++) o(a[d], this, c), !0 === b && q(a[d], this, c);
        c.sort(i);
        return c
    }
})(THREE);
THREE.Rectangle = function () {
    ...
    this.addPoint = function (f, g) {
        !0 === h ? (h = !1, b = f, c = g, d = f, e = g) : (b = b < f ? b : f, c = c < g ? c : g, d = d > f ? d : f, e = e > g ? e : g);
        a()
    };
    this.add3Points = function (f, g, l, m, n, p) {
        !0 === h ? (h = !1, b = f < l ? f < n ? f : n : l < n ? l : n, c = g < m ? g < p ? g : p : m < p ? m : p, d = f > l ? f > n ? f : n : l > n ? l : n, e = g > m ? g > p ? g : p : m > p ? m : p) : (b = f < l ? f < n ? f < b ? f : b : n < b ? n : b : l < n ? l < b ? l : b : n < b ? n : b, c = g < m ? g < p ? g < c ? g : c : p < c ? p : c : m < p ? m < c ? m : c : p < c ? p : c, d = f > l ? f > n ? f > d ? f : d : n > d ? n : d : l > n ? l > d ? l : d : n > d ? n : d, e = g > m ? g > p ? g > e ? g : e : p > e ? p : e : m > p ? m > e ? m : e : p > e ? p : e);
        a()
    };
...
THREE.Object3D.prototype = {
    ...
    updateMatrixWorld: function (a) {
        ...
        if (!0 === this.matrixWorldNeedsUpdate || !0 === a) void 0 === this.parent ? this.matrixWorld.copy(this.matrix) : this.matrixWorld.multiply(this.parent.matrixWorld, this.matrix), this.matrixWorldNeedsUpdate = !1, a = !0;
    ...
    deallocate: function () {
        var a = THREE.Object3DLibrary.indexOf(this); - 1 !== a && THREE.Object3DLibrary.splice(a, 1)
    }
};
...
THREE.Projector = function () {
    ...
    this.projectVector = function (a, b) {
        ...
        M.multiply(b.projectionMatrix, b.matrixWorldInverse);
        M.multiplyVector3(a);
        return a
    };
    this.unprojectVector = function (a, b) {
        b.projectionMatrixInverse.getInverse(b.projectionMatrix);
        M.multiply(b.matrixWorld, b.projectionMatrixInverse);
        M.multiplyVector3(a);
        return a
    };
    ...
    this.projectScene = function (g, h, m, N) {
        var ea = h.near,
            Q = h.far,
            qa = !1,
            la, O, fa, W, V, ia, Z, ca, Ga, Pa, Ia, Ua, na, Va, ib, Ra;
        y = s = r = p = 0;
        H.elements.length = 0;
        g.updateMatrixWorld();
        void 0 === h.parent && h.updateMatrixWorld();
        h.matrixWorldInverse.getInverse(h.matrixWorld);
        M.multiply(h.projectionMatrix, h.matrixWorldInverse);
        F.setFromMatrix(M);
        f = 0;
        H.objects.length = 0;
        H.sprites.length = 0;
        ...
        var eb = function (b) {
            for (var c = 0, d = b.children.length; c < d; c++) {
                var f = b.children[c];
                if (!1 !== f.visible) {
                    if (f instanceof THREE.Light) H.lights.push(f);
                    else if (f instanceof THREE.Mesh || f instanceof THREE.Line) {
                        if (!1 === f.frustumCulled || !0 === F.contains(f)) e = a(), e.object = f, null !== f.renderDepth ? e.z = f.renderDepth : (J.copy(f.matrixWorld.getPosition()), M.multiplyVector3(J), e.z = J.z), H.objects.push(e)
                    } else f instanceof THREE.Sprite || f instanceof THREE.Particle ? (e = a(), e.object = f, null !== f.renderDepth ? e.z = f.renderDepth : (J.copy(f.matrixWorld.getPosition()), M.multiplyVector3(J), e.z = J.z), H.sprites.push(e)) : (e = a(), e.object = f, null !== f.renderDepth ? e.z = f.renderDepth : (J.copy(f.matrixWorld.getPosition()), M.multiplyVector3(J), e.z = J.z), H.objects.push(e));
                    eb(f)
                }
            }
        };
        eb(g);
        !0 === m && H.objects.sort(c);
        g = 0;
        for (m = H.objects.length; g < m; g++) if (ca = H.objects[g].object, Ga = ca.matrixWorld, j = 0, ca instanceof THREE.Mesh) {
            Pa = ca.geometry;
            Ia = ca.geometry.materials;
            fa = Pa.vertices;
            Ua = Pa.faces;
            Va = Pa.faceVertexUvs;
            Pa = ca.matrixRotationWorld.extractRotation(Ga);
            ib = ca.material instanceof THREE.MeshFaceMaterial;
            la = 0;
            for (O = fa.length; la < O; la++) i = b(), i.positionWorld.copy(fa[la]), Ga.multiplyVector3(i.positionWorld), i.positionScreen.copy(i.positionWorld), M.multiplyVector4(i.positionScreen), i.positionScreen.x /= i.positionScreen.w, i.positionScreen.y /= i.positionScreen.w,
            i.visible = i.positionScreen.z > ea && i.positionScreen.z < Q;
            fa = 0;
            for (la = Ua.length; fa < la; fa++) if (O = Ua[fa], Ra = !0 === ib ? Ia[O.materialIndex] : ca.material, void 0 !== Ra) {
                ia = Ra.side;
                if (O instanceof THREE.Face3) if (W = l[O.a], V = l[O.b], Z = l[O.c], !0 === W.visible && !0 === V.visible && !0 === Z.visible) if (qa = 0 > (Z.positionScreen.x - W.positionScreen.x) * (V.positionScreen.y - W.positionScreen.y) - (Z.positionScreen.y - W.positionScreen.y) * (V.positionScreen.x - W.positionScreen.x), ia === THREE.DoubleSide || qa === (ia === THREE.FrontSide)) p === q ? (na = new THREE.RenderableFace3,
                o.push(na), q++, p++, n = na) : n = o[p++], n.v1.copy(W), n.v2.copy(V), n.v3.copy(Z);
                else continue;
                else continue;
                else if (O instanceof THREE.Face4) if (W = l[O.a], V = l[O.b], Z = l[O.c], na = l[O.d], !0 === W.visible && !0 === V.visible && !0 === Z.visible && !0 === na.visible) if (qa = 0 > (na.positionScreen.x - W.positionScreen.x) * (V.positionScreen.y - W.positionScreen.y) - (na.positionScreen.y - W.positionScreen.y) * (V.positionScreen.x - W.positionScreen.x) || 0 > (V.positionScreen.x - Z.positionScreen.x) * (na.positionScreen.y - Z.positionScreen.y) - (V.positionScreen.y - Z.positionScreen.y) * (na.positionScreen.x - Z.positionScreen.x), ia === THREE.DoubleSide || qa === (ia === THREE.FrontSide)) {
                    if (r === B) {
                ...
                n.normalWorld.copy(O.normal);
                !1 === qa && (ia === THREE.BackSide || ia === THREE.DoubleSide) && n.normalWorld.negate();
                Pa.multiplyVector3(n.normalWorld);
                n.centroidWorld.copy(O.centroid);
                Ga.multiplyVector3(n.centroidWorld);
                n.centroidScreen.copy(n.centroidWorld);
                M.multiplyVector3(n.centroidScreen);
                Z = O.vertexNormals;
                W = 0;
                for (V = Z.length; W < V; W++) na = n.vertexNormalsWorld[W], na.copy(Z[W]), !1 === qa && (ia === THREE.BackSide || ia === THREE.DoubleSide) && na.negate(), Pa.multiplyVector3(na);
                n.vertexNormalsLength = Z.length;
                W = 0;
                for (V = Va.length; W < V; W++) if (na = Va[W][fa], void 0 !== na) {
                    ia = 0;
                    for (Z = na.length; ia < Z; ia++) n.uvs[W][ia] = na[ia]
                }
                n.color = O.color;
                n.material = Ra;
...
THREE.Quaternion.slerp = function (a, b, c, d) {
    ...
    var b = Math.acos(e),
        f = Math.sqrt(1 - e * e);
    if (0.001 > Math.abs(f)) return c.w = 0.5 * (a.w + c.w), c.x = 0.5 * (a.x + c.x), c.y = 0.5 * (a.y + c.y), c.z = 0.5 * (a.z + c.z), c;
    e = Math.sin((1 - d) * b) / f;
    d = Math.sin(d * b) / f;
    c.w = a.w * e + c.w * d;
    c.x = a.x * e + c.x * d;
...
THREE.Geometry = function () {
    ...
    this.hasTangents = !1;
    this.dynamic = !0;
    this.colorsNeedUpdate = this.tangentsNeedUpdate = this.normalsNeedUpdate = this.uvsNeedUpdate = this.elementsNeedUpdate = this.verticesNeedUpdate = !1
};
THREE.Geometry.prototype = {
    ...
    computeCentroids: function () {
        var a, b, c;
        a = 0;
        for (b = this.faces.length; a < b; a++) c = this.faces[a], c.centroid.set(0,
    ...
    computeFaceNormals: function () {
        var a, b, c, d, e, f, g = new THREE.Vector3,
            h = new THREE.Vector3;
        a = 0;
        for (b = this.faces.length; a < b; a++) c = this.faces[a], d = this.vertices[c.a], e = this.vertices[c.b], f = this.vertices[c.c], g.sub(f, e), h.sub(d, e), g.crossSelf(h), g.isZero() || g.normalize(), c.normal.copy(g)
    },
    computeVertexNormals: function () {
        ...
        if (void 0 === this.__tmpVertices) {
            ...
            a = 0;
            for (b = this.faces.length; a < b; a++) c = this.faces[a], c instanceof THREE.Face3 ? c.vertexNormals = [new THREE.Vector3, new THREE.Vector3, new THREE.Vector3] : c instanceof THREE.Face4 && (c.vertexNormals = [new THREE.Vector3, new THREE.Vector3, new THREE.Vector3, new THREE.Vector3])
        } else {
    ...
    computeMorphNormals: function () {
        ...
        for (b = this.morphTargets.length; a < b; a++) {
            ...
            c = 0;
            for (d = this.faces.length; c < d; c++) e = this.faces[c], i = g.faceNormals[c], j = g.vertexNormals[c],
    ...
    computeTangents: function () {
        function a(a, b, c, d, e, f, y) {
            ...
            A = n.v - l.v;
            v = 1 / (u * A - s * z);
            H.set((A * p - z * o) * v, (A * q - z * r) * v, (A * t - z * B) * v);
            J.set((u * o - s * p) * v, (u * r - s * q) * v, (u * B - s * t) * v);
            C[b].addSelf(H);
            C[c].addSelf(H);
            C[d].addSelf(H);
            G[b].addSelf(J);
        ...
        var b, c, d, e, f, g, h, i, j, l, m, n, p, o, q, r, t, B, u, s, z, A, v, y, C = [],
            G = [],
            H = new THREE.Vector3,
            J = new THREE.Vector3,
            E = new THREE.Vector3,
            ...
            K = new THREE.Vector3;
        b = 0;
        for (c = this.vertices.length; b < c; b++) C[b] = new THREE.Vector3,
        ...
        for (c = this.faces.length; b < c; b++) {
            f = this.faces[b];
            for (d = 0; d < f.vertexNormals.length; d++) K.copy(f.vertexNormals[d]), e = f[F[d]], y = C[e], E.copy(y), E.subSelf(K.multiplyScalar(K.dot(y))).normalize(), M.cross(f.vertexNormals[d], y), e = M.dot(G[e]), e = 0 > e ? -1 : 1, f.vertexTangents[d] = new THREE.Vector4(E.x, E.y, E.z, e)
        }
        this.hasTangents = !0
    },
    computeBoundingBox: function () {
        ...
        if (0 < this.vertices.length) {
            ...
            for (var b = this.boundingBox.min, c = this.boundingBox.max, d = 1, e = this.vertices.length; d < e; d++)(a = this.vertices[d], a.x < b.x ? b.x = a.x : a.x > c.x && (c.x = a.x), a.y < b.y ? b.y = a.y : a.y > c.y && (c.y = a.y), a.z < b.z) ? b.z = a.z : a.z > c.z && (c.z = a.z)
    ...
    mergeVertices: function () {
        var a = {}, b = [],
            ...
            f, g, h, i;
        f = 0;
        for (g = this.vertices.length; f < g; f++) d = this.vertices[f], d = [Math.round(d.x * e), Math.round(d.y * e), Math.round(d.z * e)].join("_"),
        void 0 === a[d] ? (a[d] = f, b.push(this.vertices[f]), c[f] = b.length - 1) : c[f] = c[a[d]];
        f = 0;
        for (g = this.faces.length; f < g; f++) if (a = this.faces[f], a instanceof THREE.Face3) a.a = c[a.a], a.b = c[a.b], a.c = c[a.c];
    ...
    clone: function () {},
    deallocate: function () {
        var a = THREE.GeometryLibrary.indexOf(this); - 1 !== a && THREE.GeometryLibrary.splice(a, 1)
    }
};
...
THREE.BufferGeometry.prototype = {
    ...
    computeBoundingBox: function () {
        ...
        if (a) for (var b = this.boundingBox, c, d, e, f = 0, g = a.length; f < g; f += 3)(c = a[f], d = a[f + 1], e = a[f + 2], c < b.min.x ? b.min.x = c : c > b.max.x && (b.max.x = c), d < b.min.y ? b.min.y = d : d > b.max.y && (b.max.y = d), e < b.min.z) ? b.min.z = e : e > b.max.z && (b.max.z = e);
    ...
    computeVertexNormals: function () {
        if (this.attributes.position && this.attributes.index) {
            ...
            var e = this.offsets,
                ...
                i, j, l, m, n, p, o = new THREE.Vector3,
                q = new THREE.Vector3,
                r = new THREE.Vector3,
                t = new THREE.Vector3,
                B = new THREE.Vector3;
            ...
            for (d = e.length; c < d; ++c) {
                ...
                var u = e[c].index;
                a = b;
                for (b += i; a < b; a += 3) i = u + f[a], j = u + f[a + 1], l = u + f[a + 2], m = g[3 * i], n = g[3 * i + 1], p = g[3 * i + 2], o.set(m, n, p), m = g[3 * j], n = g[3 * j + 1], p = g[3 * j + 2], q.set(m, n, p), m = g[3 * l], n = g[3 * l + 1], p = g[3 * l + 2], r.set(m, n, p), t.sub(r, q), B.sub(o, q), t.crossSelf(B), h[3 * i] += t.x, h[3 * i + 1] += t.y, h[3 * i + 2] += t.z, h[3 * j] += t.x, h[3 * j + 1] += t.y, h[3 * j + 2] += t.z, h[3 * l] += t.x, h[3 * l + 1] += t.y, h[3 * l + 2] += t.z
            }
            a = 0;
            for (b = h.length; a < b; a += 3) m = h[a], n = h[a + 1], p = h[a + 2], c = 1 / Math.sqrt(m * m + n * n + p * p), h[a] *= c, h[a + 1] *= c, h[a + 2] *= c;
    ...
    computeTangents: function () {
        function a(a) {
            ...
            ea = i[a];
            L.copy(ea);
            L.subSelf($.multiplyScalar($.dot(ea))).normalize();
            R.cross(Y, ea);
            Q = R.dot(j[a]);
            N = 0 > Q ? -1 : 1;
            h[4 * a] = L.x;
        ...
        if (void 0 === this.attributes.index || void 0 === this.attributes.position || void 0 === this.attributes.normal || void 0 === this.attributes.uv) console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");
            ...
            i = [], j = [], g = 0; g < f; g++) i[g] = new THREE.Vector3, j[g] = new THREE.Vector3;
            var l, m, n, p, o, q, r, t, B, u, s, z, A, v, y, f = new THREE.Vector3,
                g = new THREE.Vector3,
                C, G, H, J, E, M, K, F = this.offsets;
            H = 0;
            for (J = F.length; H < J; ++H) {
                G = F[H].start;
                E = F[H].count;
                var I = F[H].index;
                C = G;
                for (G += E; C < G; C += 3) E = I + b[C], M = I + b[C + 1], K = I + b[C + 2], l = c[3 * E], m = c[3 * E + 1], n = c[3 * E + 2], p = c[3 * M], o = c[3 * M + 1], q = c[3 * M + 2], r = c[3 * K], t = c[3 * K + 1], B = c[3 * K + 2], u = e[2 * E], s = e[2 * E + 1], z = e[2 * M], A = e[2 * M + 1], v = e[2 * K], y = e[2 * K + 1], p -= l, l = r - l, o -= m, m = t - m, q -= n, n = B - n, z -= u, u = v - u, A -= s, s = y - s, y = 1 / (z * s - u * A), f.set((s * p - A * l) * y, (s * o - A * m) * y, (s * q - A * n) * y), g.set((z * l - u * p) * y, (z * m - u * o) * y, (z * n - u * q) * y), i[E].addSelf(f), i[M].addSelf(f), i[K].addSelf(f), j[E].addSelf(g), j[M].addSelf(g), j[K].addSelf(g)
            }
            ...
            for (J = F.length; H < J; ++H) {
                ...
                I = F[H].index;
                C = G;
                for (G += E; C < G; C += 3) E = I + b[C], M = I + b[C + 1], K = I + b[C + 2], a(E), a(M), a(K)
            }
    ...
    createMaterial: function (a, b) {
        ...
        function e(a, e, f, h, i, j, r) {
            var t = f.toLowerCase().endsWith(".dds"),
                B = b + "/" + f;
            if (t) {
                var u = THREE.ImageUtils.loadCompressedTexture(B);
                a[e] = u
            } else u = document.createElement("canvas"), a[e] = new THREE.Texture(u);
            a[e].sourceFile = f;
            if (h && (a[e].repeat.set(h[0], h[1]), 1 !== h[0] && (a[e].wrapS = THREE.RepeatWrapping), 1 !== h[1])) a[e].wrapT = THREE.RepeatWrapping;
        ...
        j.enableAO.value = !0), j.uDiffuseColor.value.setHex(i.color), j.uSpecularColor.value.setHex(i.specular), j.uAmbientColor.value.setHex(i.ambient), j.uShininess.value = i.shininess, void 0 !== i.opacity && (j.uOpacity.value = i.opacity), i = new THREE.ShaderMaterial({
...
THREE.BinaryLoader.prototype.createBinModel = function (a, b, c, d) {
    var e = function (b) {
        var c, e, i, j, l, m, n, p, o, q, r, t, B, u, s;
        ...
        function y(b, c) {
            var d, e, f, g, h, i, j, l, m = new Uint32Array(a, c, 3 * b);
            for (d = 0; d < b; d++) {
                e = m[3 * d];
                f = m[3 * d + 1];
                g = m[3 * d + 2];
                ...
                n.push(new THREE.UV(f,
                l));
                g.push(n)
            }
        }
        function C(b, c) {
            var d, e, f, g, h, i, j, l, m, n, o = new Uint32Array(a, c, 4 * b);
            for (d = 0; d < b; d++) {
                e = o[4 * d];
                f = o[4 * d + 1];
                g = o[4 * d + 2];
        ...
        function G(b, c, d) {
            ...
            M.faces.push(new THREE.Face3(e, f, g, null, null, h))
        }
        function H(b, c, d) {
            for (var e, f, g, h, i, c = new Uint32Array(a, c, 4 * b), j = new Uint16Array(a, d, b), d = 0; d < b; d++) e = c[4 * d], f = c[4 * d + 1], g = c[4 * d + 2], h = c[4 * d + 3], i = j[d], M.faces.push(new THREE.Face4(e, f, g, h, null, null, i))
        }
        function J(b, c, d, e) {
            for (var f, g, h, i, j, l, m, c = new Uint32Array(a, c, 3 * b), d = new Uint32Array(a, d, 3 * b), n = new Uint16Array(a, e, b), e = 0; e < b; e++) {
                f = c[3 * e];
                g = c[3 * e + 1];
                h = c[3 * e + 2];
                j = d[3 * e];
                ...
                var q = F[3 * m],
                    r = F[3 * m + 1];
                m = F[3 * m + 2];
                M.faces.push(new THREE.Face3(f, g, h, [new THREE.Vector3(F[3 * j], F[3 * j + 1], F[3 * j + 2]), new THREE.Vector3(o, p, l), new THREE.Vector3(q, r, m)], null, i))
            }
        }
        function E(b, c, d, e) {
            for (var f, g, h, i, j, l, m, n, o, c = new Uint32Array(a, c, 4 * b), d = new Uint32Array(a, d, 4 * b), p = new Uint16Array(a, e, b), e = 0; e < b; e++) {
                f = c[4 * e];
                g = c[4 * e + 1];
                h = c[4 * e + 2];
                i = c[4 * e + 3];
                ...
                var u = F[3 * o],
                    v = F[3 * o + 1];
                o = F[3 * o + 2];
                M.faces.push(new THREE.Face4(f,
                g, h, i, [new THREE.Vector3(F[3 * l], F[3 * l + 1], F[3 * l + 2]), new THREE.Vector3(q, r, m), new THREE.Vector3(s, t, n), new THREE.Vector3(u, v, o)], null, j))
            }
        }
        var M = this,
            K = 0,
        ...
        THREE.Loader.prototype.initMaterials(M, d, b);
        s = a;
        R = K;
        b = new Uint8Array(s, R, 12);
        q = "";
        for (B = 0; 12 > B; B++) q += String.fromCharCode(b[R + B]);
        c = A(s, R + 12);
        A(s, R + 13);
        A(s, R + 14);
        A(s, R + 15);
        ...
        j = u * ($ + 4 * j);
        $ = K;
        var K = new Float32Array(a, K, 3 * m),
            Y, N, ea, Q;
        for (Y = 0; Y < m; Y++) N = K[3 * Y], ea = K[3 * Y + 1], Q = K[3 * Y + 2], M.vertices.push(new THREE.Vector3(N, ea, Q));
        m = K = $ + 3 * m * Float32Array.BYTES_PER_ELEMENT;
        if (n) {
            K = new Int8Array(a, K, 3 * n);
            for ($ = 0; $ < n; $++) Y = K[3 * $], N = K[3 * $ + 1], ea = K[3 * $ + 2], F.push(Y / 127, N / 127, ea / 127)
        }
        K = m + 3 * n * Int8Array.BYTES_PER_ELEMENT;
        n = K += z(3 * n);
        if (p) {
            K = new Float32Array(a, K, 2 * p);
            for (m = 0; m < p; m++) $ = K[2 * m], Y = K[2 * m + 1], I.push($, Y)
        }
        p = K = n + 2 * p * Float32Array.BYTES_PER_ELEMENT;
        L = p + L + z(2 * o);
        n = L + c + z(2 * q);
        c = n + e + z(2 * r);
        e = c + l + z(2 * t);
        ...
        l = R + i + z(2 * b);
        i = l + j + z(2 * u);
        r && (j = n + 3 * r * Uint32Array.BYTES_PER_ELEMENT, G(r, n, j + 3 * r * Uint32Array.BYTES_PER_ELEMENT), y(r, j));
        t && (r = c + 3 * t * Uint32Array.BYTES_PER_ELEMENT, j = r + 3 * t * Uint32Array.BYTES_PER_ELEMENT, J(t, c, r, j + 3 * t * Uint32Array.BYTES_PER_ELEMENT), y(t, j));
        u && (t = l + 4 * u * Uint32Array.BYTES_PER_ELEMENT, H(u, l, t + 4 * u * Uint32Array.BYTES_PER_ELEMENT),
        C(u, t));
        s && (u = i + 4 * s * Uint32Array.BYTES_PER_ELEMENT, t = u + 4 * s * Uint32Array.BYTES_PER_ELEMENT, E(s, i, u, t + 4 * s * Uint32Array.BYTES_PER_ELEMENT), C(s, t));
        o && G(o, p, p + 3 * o * Uint32Array.BYTES_PER_ELEMENT);
        q && (o = L + 3 * q * Uint32Array.BYTES_PER_ELEMENT, J(q, L, o, o + 3 * q * Uint32Array.BYTES_PER_ELEMENT));
        B && H(B, e, e + 4 * B * Uint32Array.BYTES_PER_ELEMENT);
        b && (q = R + 4 * b * Uint32Array.BYTES_PER_ELEMENT, E(b, R, q, q + 4 * b * Uint32Array.BYTES_PER_ELEMENT));
...
THREE.JSONLoader.prototype.createModel = function (a, b, c) {
    ...
    var f, g, h, i, j, l, m, n, p, o, q, r, t, B, u = a.faces;
    p = a.vertices;
    var s = a.normals,
        z = a.colors,
        A = 0;
    ...
    c = 0;
    for (i = p.length; c < i;) j = new THREE.Vector3, j.x = p[c++] * e, j.y = p[c++] * e, j.z = p[c++] * e, d.vertices.push(j);
    c = 0;
    for (i = u.length; c < i;) {
        p = u[c++];
        j = p & 1;
        ...
        o = p & 64;
        p &= 128;
        j ? (q = new THREE.Face4, q.a = u[c++], q.b = u[c++], q.c = u[c++], q.d = u[c++], j = 4) : (q = new THREE.Face3, q.a = u[c++], q.b = u[c++], q.c = u[c++], j = 3);
        h && (h = u[c++], q.materialIndex = h);
        h = d.faces.length;
        if (f) for (f = 0; f < A; f++) r = a.uvs[f], n = u[c++], B = r[2 * n], n = r[2 * n + 1], d.faceUvs[f][h] = new THREE.UV(B, n);
        if (g) for (f = 0; f < A; f++) {
            r = a.uvs[f];
            t = [];
            for (g = 0; g < j; g++) n = u[c++], B = r[2 * n], n = r[2 * n + 1], t[g] = new THREE.UV(B, n);
            d.faceVertexUvs[f][h] = t
        }
        m && (m = 3 * u[c++], g = new THREE.Vector3, g.x = s[m++], g.y = s[m++], g.z = s[m], q.normal = g);
        if (l) for (f = 0; f < j; f++) m = 3 * u[c++], g = new THREE.Vector3, g.x = s[m++], g.y = s[m++], g.z = s[m], q.vertexNormals.push(g);
        o && (l = u[c++], l = new THREE.Color(z[l]), q.color = l);
        if (p) for (f = 0; f < j; f++) l = u[c++], l = new THREE.Color(z[l]), q.vertexColors.push(l);
        d.faces.push(q)
    }
    if (a.skinWeights) {
        c = 0;
        for (i = a.skinWeights.length; c < i; c += 2) u = a.skinWeights[c], s = a.skinWeights[c + 1], d.skinWeights.push(new THREE.Vector4(u, s, 0, 0))
    }
    if (a.skinIndices) {
        c = 0;
        for (i = a.skinIndices.length; c < i; c += 2) u = a.skinIndices[c], s = a.skinIndices[c + 1], d.skinIndices.push(new THREE.Vector4(u,
        s, 0, 0))
    }
    d.bones = a.bones;
    ...
    if (void 0 !== a.morphTargets) {
        ...
        for (i = a.morphTargets.length; c < i; c++) {
            ...
            z = d.morphTargets[c].vertices;
            A = a.morphTargets[c].vertices;
            u = 0;
            for (s = A.length; u < s; u += 3) p = new THREE.Vector3, p.x = A[u] * e, p.y = A[u + 1] * e, p.z = A[u + 2] * e, z.push(p)
        }
    }
    if (void 0 !== a.morphColors) {
        ...
        for (i = a.morphColors.length; c < i; c++) {
            ...
            z = a.morphColors[c].colors;
            e = 0;
            for (u = z.length; e < u; e += 3) A = new THREE.Color(16755200), A.setRGB(z[e], z[e + 1], z[e + 2]), s.push(A)
        }
    }
    d.computeCentroids();
    ...
    parse: function (a, b) {
            ...
            for (var f = 0; f < a.materials.length; ++f) {
                var g = a.materials[f],
                    h = function (a) {
                        ...
                        a = Math.log(a) / Math.LN2;
                        return Math.pow(2, Math.round(a))
                    }, j = function (a, d, e, f, g, l) {
                        a[d] = new THREE.Texture;
                        a[d].sourceFile = e;
                        if (f && (a[d].repeat.set(f[0], f[1]), 1 !== f[0] && (a[d].wrapS = THREE.RepeatWrapping), 1 !== f[1])) a[d].wrapT = THREE.RepeatWrapping;
                        g && a[d].offset.set(g[0], g[1]);
                        if (l && (f = {
                            repeat: THREE.RepeatWrapping,
                            mirror: THREE.MirroredRepeatWrapping
                        }, void 0 !== f[l[0]] && (a[d].wrapS = f[l[0]]), void 0 !== f[l[1]])) a[d].wrapT = f[l[1]];
                        var j = a[d],
                        ...
                        a.addEventListener("load", function (a) {
                            ...
                            if (!h(a.width) || !h(a.height)) {
                                var b = i(a.width),
                                    c = i(a.height);
                                j.image = document.createElement("canvas");
                                j.image.width = b;
                                j.image.height = c;
                                j.image.getContext("2d").drawImage(a, 0, 0, b, c)
                            } else j.image = a;
                            j.needsUpdate = !0
                        });
                ...
                if (g.shading) {
                    ...
                    "phong" === p ? m = "MeshPhongMaterial" : "basic" === p && (m = "MeshBasicMaterial")
                }
                void 0 !== g.blending && void 0 !== THREE[g.blending] && (n.blending = THREE[g.blending]);
                if (void 0 !== g.transparent || 1 > g.opacity) n.transparent = g.transparent;
                void 0 !== g.depthTest && (n.depthTest = g.depthTest);
                void 0 !== g.depthWrite && (n.depthWrite = g.depthWrite);
                void 0 !== g.vertexColors && ("face" == g.vertexColors ? n.vertexColors = THREE.FaceColors : g.vertexColors && (n.vertexColors = THREE.VertexColors));
                g.colorDiffuse ? n.color = l(g.colorDiffuse) : g.DbgColor && (n.color = g.DbgColor);
                g.colorSpecular && (n.specular = l(g.colorSpecular));
                g.colorAmbient && (n.ambient = l(g.colorAmbient));
                g.transparency && (n.opacity = g.transparency);
                g.specularCoef && (n.shininess = g.specularCoef);
                void 0 !== g.visible && (n.visible = g.visible);
                void 0 !== g.flipSided && (n.side = THREE.BackSide);
                void 0 !== g.doubleSided && (n.side = THREE.DoubleSide);
                void 0 !== g.wireframe && (n.wireframe = g.wireframe);
                ...
                g.mapBump && j(n, "bumpMap", g.mapBump, g.mapBumpRepeat, g.mapBumpOffset,
                g.mapBumpWrap);
                ...
                g.mapNormal ? (j = THREE.ShaderUtils.lib.normal, l = THREE.UniformsUtils.clone(j.uniforms), l.tNormal.value = n.normalMap, g.mapNormalFactor && l.uNormalScale.value.set(g.mapNormalFactor, g.mapNormalFactor), n.map && (l.tDiffuse.value = n.map, l.enableDiffuse.value = !0), n.specularMap && (l.tSpecular.value = n.specularMap,
                l.enableSpecular.value = !0), n.lightMap && (l.tAO.value = n.lightMap, l.enableAO.value = !0), l.uDiffuseColor.value.setHex(n.color), l.uSpecularColor.value.setHex(n.specular), l.uAmbientColor.value.setHex(n.ambient), l.uShininess.value = n.shininess, void 0 !== n.opacity && (l.uOpacity.value = n.opacity), n = new THREE.ShaderMaterial({
                ...
                void 0 !== g.DbgName && (n.name = g.DbgName);
                d.materials[f] = n
            }
        }
        var g = a.faces,
            ...
            j = a.colors,
            l = 0;
        if (a.uvs) for (f = 0; f < a.uvs.length; f++) a.uvs[f].length && l++;
        for (f = 0; f < l; f++) d.faceUvs[f] = [], d.faceVertexUvs[f] = [];
        m = 0;
        for (p = o.length; m < p;) {
        ...
        for (p = g.length; m < p;) {
            ...
            if (r & 1) {
                ...
                r.d = g[m++];
                var z = 4
            } else r = new THREE.Face3, r.a = g[m++], r.b = g[m++], r.c = g[m++], z = 3;
            t && (t = g[m++], r.materialIndex = t);
            var A = d.faces.length;
            if (f) for (f = 0; f < l; f++) {
                var v = a.uvs[f],
                    t = g[m++],
                    y = v[2 * t],
                    t = v[2 * t + 1];
                d.faceUvs[f][A] = new THREE.UV(y, t)
            }
            if (B) for (f = 0; f < l; f++) {
                for (var v = a.uvs[f], B = [], C = 0; C < z; C++) t = g[m++], y = v[2 * t], t = v[2 * t + 1], B[C] = new THREE.UV(y, t);
                d.faceVertexUvs[f][A] = B
            }
            u && (u = 3 * g[m++], t = new THREE.Vector3, t.x = n[u++], t.y = n[u++], t.z = n[u], r.normal = t);
            if (o) for (f = 0; f < z; f++) u = 3 * g[m++], t = new THREE.Vector3, t.x = n[u++], t.y = n[u++], t.z = n[u], r.vertexNormals.push(t);
            s && (o = g[m++], r.color = new THREE.Color(j[o]));
            if (q) for (f = 0; f < z; f++) o = g[m++], r.vertexColors.push(new THREE.Color(j[o]));
            d.faces.push(r)
        }
        if (a.skinWeights) {
            f = 0;
            for (g = a.skinWeights.length; f < g; f += 2) d.skinWeights.push(new THREE.Vector4(a.skinWeights[f], a.skinWeights[f + 1], 0, 0))
        }
        if (a.skinIndices) {
            f = 0;
            for (g = a.skinIndices.length; f < g; f += 2) n = 0, d.skinIndices.push(new THREE.Vector4(a.skinIndices[f], a.skinIndices[f + 1], n, 0))
        }
        d.bones = a.bones;
        d.animation = a.animation;
        if (a.morphTargets) {
            ...
            for (g = a.morphTargets.length; f < g; f++) {
                ...
                t = 0;
                for (l = j.length; t < l; t += 3) q = new THREE.Vector3, q.x = j[t] * e, q.y = j[t + 1] * e, q.z = j[t + 2] * e, n.push(q)
            }
        }
        if (a.morphColors) {
            f = 0;
            for (g = a.morphColors.length; f < g; f++) {
                ...
                n = 0;
                for (l = j.length; n < l; n += 3) m = new THREE.Color(16755200), m.setRGB(j[n], j[n + 1], j[n + 2]), e.push(m)
            }
        }
        d.computeCentroids();
        d.computeFaceNormals();
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
    ...
    function e(a, b) {
        for (var c in b) if (void 0 === I.objects[c]) {
            var d = b[c],
                f = null;
            if (void 0 !== d.geometry) {
                if (y = I.geometries[d.geometry]) f = !1, C = I.materials[d.materials[0]], (f = C instanceof THREE.ShaderMaterial) && y.computeTangents(), B = d.position, u = d.rotation, s = d.quaternion, z = d.scale, r = d.matrix, s = 0, 0 === d.materials.length && (C = new THREE.MeshFaceMaterial), 1 < d.materials.length && (C = new THREE.MeshFaceMaterial), d.morph ? (f = new THREE.MorphAnimMesh(y, C), void 0 !== d.duration && (f.duration = d.duration), void 0 !== d.time && (f.time = d.time), void 0 !== d.mirroredLoop && (f.mirroredLoop = d.mirroredLoop), C.morphNormals && y.computeMorphNormals()) : f = new THREE.Mesh(y, C), f.name = c, r ? (f.matrixAutoUpdate = !1, f.matrix.set(r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10], r[11], r[12], r[13], r[14], r[15])) : (f.position.set(B[0], B[1], B[2]), s ? (f.quaternion.set(s[0], s[1], s[2], s[3]), f.useQuaternion = !0) : f.rotation.set(u[0], u[1], u[2]), f.scale.set(z[0],
                z[1], z[2])), f.visible = d.visible, f.castShadow = d.castShadow, f.receiveShadow = d.receiveShadow, a.add(f), I.objects[c] = f
            } else B = d.position, u = d.rotation, s = d.quaternion, z = d.scale, s = 0, f = new THREE.Object3D, f.name = c, f.position.set(B[0], B[1], B[2]), s ? (f.quaternion.set(s[0], s[1], s[2], s[3]), f.useQuaternion = !0) : f.rotation.set(u[0], u[1], u[2]), f.scale.set(z[0], z[1], z[2]), f.visible = void 0 !== d.visible ? d.visible : !1, a.add(f), I.objects[c] = f, I.empties[c] = f;
            if (f) {
                if (void 0 !== d.properties) for (var g in d.properties) f.properties[g] = d.properties[g];
    ...
    var i = this,
        ...
        l, m, n, p, o, q, r, t, B, u, s, z, A, v, y, C, G, H, J, E, M, K, F, I, L = a;
    for (A in this.geometryHandlerMap) this.geometryHandlerMap[A].loaderObject = new this.geometryHandlerMap[A].loaderClass;
    M = E = 0;
    I = {
    ...
    if (L.transform && (a = L.transform.position, c = L.transform.rotation, A = L.transform.scale, a && I.scene.position.set(a[0], a[1], a[2]), c && I.scene.rotation.set(c[0], c[1], c[2]), A && I.scene.scale.set(A[0], A[1], A[2]), a || c || A)) I.scene.updateMatrix(), I.scene.updateMatrixWorld();
    a = function (a) {
        return function () {
            M -= a;
            h();
    ...
    for (p in L.cameras) A = L.cameras[p], "perspective" === A.type ? G = new THREE.PerspectiveCamera(A.fov, A.aspect, A.near, A.far) : "ortho" === A.type && (G = new THREE.OrthographicCamera(A.left, A.right, A.top, A.bottom, A.near, A.far)), B = A.position, c = A.target, A = A.up, G.position.set(B[0], B[1], B[2]), G.target = new THREE.Vector3(c[0], c[1], c[2]), A && G.up.set(A[0], A[1], A[2]), I.cameras[p] = G;
    for (n in L.lights) c = L.lights[n], p = void 0 !== c.color ? c.color : 16777215, G = void 0 !== c.intensity ? c.intensity : 1, "directional" === c.type ? (B = c.direction, t = new THREE.DirectionalLight(p,
    G), t.position.set(B[0], B[1], B[2]), t.position.normalize()) : "point" === c.type ? (B = c.position, t = c.distance, t = new THREE.PointLight(p, G, t), t.position.set(B[0], B[1], B[2])) : "ambient" === c.type && (t = new THREE.AmbientLight(p)), I.scene.add(t), I.lights[n] = t;
    for (o in L.fogs) n = L.fogs[o], "linear" === n.type ? H = new THREE.Fog(0, n.near, n.far) : "exp2" === n.type && (H = new THREE.FogExp2(0, n.density)), A = n.color, H.color.setRGB(A[0], A[1], A[2]), I.fogs[o] = H;
    I.cameras && L.defaults.camera && (I.currentCamera = I.cameras[L.defaults.camera]);
    I.fogs && L.defaults.fog && (I.scene.fog = I.fogs[L.defaults.fog]);
    A = L.defaults.bgcolor;
    I.bgColor = new THREE.Color;
    I.bgColor.setRGB(A[0], A[1], A[2]);
    I.bgColorAlpha = L.defaults.bgalpha;
    for (l in L.geometries) o = L.geometries[l], o.type in this.geometryHandlerMap && (E += 1, i.onLoadStart());
    K = E;
    for (l in L.geometries) if (o = L.geometries[l], "cube" === o.type) y = new THREE.CubeGeometry(o.width, o.height, o.depth, o.segmentsWidth, o.segmentsHeight, o.segmentsDepth, null, o.flipped, o.sides), I.geometries[l] = y;
    else if ("plane" === o.type) y = new THREE.PlaneGeometry(o.width, o.height, o.segmentsWidth, o.segmentsHeight), I.geometries[l] = y;
    else if ("sphere" === o.type) y = new THREE.SphereGeometry(o.radius, o.segmentsWidth, o.segmentsHeight), I.geometries[l] = y;
    else if ("cylinder" === o.type) y = new THREE.CylinderGeometry(o.topRad, o.botRad, o.height, o.radSegs, o.heightSegs), I.geometries[l] = y;
    else if ("torus" === o.type) y = new THREE.TorusGeometry(o.radius, o.tube, o.segmentsR, o.segmentsT), I.geometries[l] = y;
    else if ("icosahedron" === o.type) y = new THREE.IcosahedronGeometry(o.radius,
    o.subdivisions), I.geometries[l] = y;
    else if (o.type in this.geometryHandlerMap) {
        H = {};
        for (J in o) "type" !== J && "url" !== J && (H[J] = o[J]);
        this.geometryHandlerMap[o.type].loaderObject.load(d(o.url, L.urlBaseType), f(l), H)
    } else "embedded" === o.type && (o = L.embeds[o.id], o.metadata = L.metadata, o && this.geometryHandlerMap.ascii.loaderObject.createModel(o, g(l), ""));
    for (q in L.textures) if (l = L.textures[q], l.url instanceof Array) {
        M += l.url.length;
        for (J = 0; J < l.url.length; J++) i.onLoadStart()
    } else M += 1, i.onLoadStart();
    F = M;
    for (q in L.textures) {
        l = L.textures[q];
        ...
        if (l.url instanceof Array) {
            o = l.url.length;
            H = [];
            for (J = 0; J < o; J++) H[J] = d(l.url[J], L.urlBaseType);
            J = (J = H[0].endsWith(".dds")) ? THREE.ImageUtils.loadCompressedTextureCube(H, l.mapping, a(o)) : THREE.ImageUtils.loadTextureCube(H, l.mapping, a(o))
        } else {
            J = l.url.toLowerCase().endsWith(".dds");
            o = d(l.url, L.urlBaseType);
            H = a(1);
            J = J ? THREE.ImageUtils.loadCompressedTexture(o, l.mapping, H) : THREE.ImageUtils.loadTexture(o, l.mapping,
            H);
            void 0 !== THREE[l.minFilter] && (J.minFilter = THREE[l.minFilter]);
            void 0 !== THREE[l.magFilter] && (J.magFilter = THREE[l.magFilter]);
            l.anisotropy && (J.anisotropy = l.anisotropy);
            if (l.repeat && (J.repeat.set(l.repeat[0], l.repeat[1]), 1 !== l.repeat[0] && (J.wrapS = THREE.RepeatWrapping), 1 !== l.repeat[1])) J.wrapT = THREE.RepeatWrapping;
            l.offset && J.offset.set(l.offset[0], l.offset[1]);
            if (l.wrap && (o = {
                repeat: THREE.RepeatWrapping,
                mirror: THREE.MirroredRepeatWrapping
            }, void 0 !== o[l.wrap[0]] && (J.wrapS = o[l.wrap[0]]), void 0 !== o[l.wrap[1]])) J.wrapT = o[l.wrap[1]]
        }
        I.textures[q] = J
    }
    for (m in L.materials) {
        ...
        for (v in r.parameters) "envMap" === v || "map" === v || "lightMap" === v || "bumpMap" === v ? r.parameters[v] = I.textures[r.parameters[v]] : "shading" === v ? r.parameters[v] = "flat" === r.parameters[v] ? THREE.FlatShading : THREE.SmoothShading : "side" === v ? r.parameters[v] = "double" == r.parameters[v] ? THREE.DoubleSide : "back" == r.parameters[v] ? THREE.BackSide : THREE.FrontSide : "blending" === v ? r.parameters[v] = r.parameters[v] in THREE ? THREE[r.parameters[v]] : THREE.NormalBlending :
            "combine" === v ? r.parameters[v] = "MixOperation" == r.parameters[v] ? THREE.MixOperation : THREE.MultiplyOperation : "vertexColors" === v ? "face" == r.parameters[v] ? r.parameters[v] = THREE.FaceColors : r.parameters[v] && (r.parameters[v] = THREE.VertexColors) : "wrapRGB" === v && (q = r.parameters[v], r.parameters[v] = new THREE.Vector3(q[0], q[1], q[2]));
...
THREE.Material.prototype.deallocate = function () {
    var a = THREE.MaterialLibrary.indexOf(this); - 1 !== a && THREE.MaterialLibrary.splice(a, 1)
};
...
THREE.Texture.prototype = {
    ...
    deallocate: function () {
        var a = THREE.TextureLibrary.indexOf(this); - 1 !== a && THREE.TextureLibrary.splice(a, 1)
    }
};
...
THREE.ParticleSystem = function (a, b) {
    ...
    this.geometry && (null === this.geometry.boundingSphere && this.geometry.computeBoundingSphere(), this.boundRadius = a.boundingSphere.radius);
...
THREE.Mesh = function (a, b) {
    ...
    if (this.geometry && (null === this.geometry.boundingSphere && this.geometry.computeBoundingSphere(), this.boundRadius = a.boundingSphere.radius, this.geometry.morphTargets.length)) {
...
THREE.SkinnedMesh.prototype.updateMatrixWorld = function (a) {
    ...
    a = 0;
    for (b = this.bones.length; a < b; a++) THREE.SkinnedMesh.offsetMatrix.multiply(this.bones[a].skinMatrix, this.boneInverses[a]), THREE.SkinnedMesh.offsetMatrix.flattenToArrayOffset(this.boneMatrices, 16 * a);
...
THREE.MorphAnimMesh.prototype.updateAnimation = function (a) {
    ...
    if (this.mirroredLoop) {
        if (this.time > this.duration || 0 > this.time) if (this.direction *= -1, this.time > this.duration && (this.time = this.duration, this.directionBackwards = !0), 0 > this.time) this.time = 0, this.directionBackwards = !1
...
THREE.Sprite.prototype.clone = function (a) {
    ...
    THREE.Object3D.prototype.clone.call(this,
    a);
    return a
};
...
THREE.CanvasRenderer = function (a) {
    function b(a) {
        B !== a && (B = q.globalAlpha = a)
    }
    function c(a) {
        u !== a && (a === THREE.NormalBlending ? q.globalCompositeOperation = "source-over" : a === THREE.AdditiveBlending ? q.globalCompositeOperation = "lighter" : a === THREE.SubtractiveBlending && (q.globalCompositeOperation = "darker"), u = a)
    }
    function d(a) {
        s !== a && (s = q.strokeStyle = a)
    }
    function e(a) {
        z !== a && (z = q.fillStyle = a)
    }
    ...
    var a = a || {}, f = this,
        ...
        v = null,
        y = null,
        C, G, H, J, E = new THREE.RenderableVertex,
        M = new THREE.RenderableVertex,
        K, F, I, L, R, $, Y, N, ea, Q, qa, la, O = new THREE.Color,
        fa = new THREE.Color,
        W = new THREE.Color,
        V = new THREE.Color,
        ia = new THREE.Color,
        Z = new THREE.Color,
        ca = new THREE.Color,
        Ga = {}, Pa = {}, Ia, Ua, na, Va, ib, Ra, eb, pb, Pb, db, $a = new THREE.Rectangle,
    ...
    this.clear = function () {
        q.setTransform(1, 0, 0, -1, p, o);
        !1 === Ja.isEmpty() && (Ja.minSelf($a), Ja.inflate(2), 1 > t && q.clearRect(Math.floor(Ja.getX()), Math.floor(Ja.getY()), Math.floor(Ja.getWidth()), Math.floor(Ja.getHeight())),
        0 < t && (c(THREE.NormalBlending), b(1), e("rgba(" + Math.floor(255 * r.r) + "," + Math.floor(255 * r.g) + "," + Math.floor(255 * r.b) + "," + t + ")"), q.fillRect(Math.floor(Ja.getX()), Math.floor(Ja.getY()), Math.floor(Ja.getWidth()), Math.floor(Ja.getHeight()))), Ja.empty())
    };
    this.render = function (a, l) {
        function m(a, b, c) {
            for (var d = 0, e = i.length; d < e; d++) {
                ...
                THREE.PointLight && (h = f.matrixWorld.getPosition(), k = b.dot(ra.sub(h, a).normalize()), 0 >= k || (k *= 0 == f.distance ? 1 : 1 - Math.min(a.distanceTo(h) / f.distance, 1), 0 != k && (k *= f.intensity, c.r += g.r * k, c.g += g.g * k, c.b += g.b * k)))
            }
        }
        function n(a, d, e, g, h, k, i, j) {
            ...
            $ = e.positionScreen.y;
            r(K, F, I, L, R, $);
            (j instanceof THREE.MeshLambertMaterial || j instanceof
        ...
        function Ba(a, b, c, d, f, g, h, k, i, j, l, m, n) {
            if (!(n instanceof THREE.DataTexture || void 0 === n.image || 0 == n.image.width)) {
                if (!0 === n.needsUpdate) {
                    var Ba = n.wrapS == THREE.RepeatWrapping,
                        o = n.wrapT == THREE.RepeatWrapping;
                    Ga[n.id] = q.createPattern(n.image, !0 === Ba && !0 === o ? "repeat" : !0 === Ba && !1 === o ? "repeat-x" : !1 === Ba && !0 === o ? "repeat-y" : "no-repeat");
                    n.needsUpdate = !1
                }
                void 0 === Ga[n.id] ? e("rgba(0,0,0,1)") : e(Ga[n.id]);
                var Ba = n.offset.x / n.repeat.x,
                    o = n.offset.y / n.repeat.y,
        ...
        if (!1 === l instanceof THREE.Camera) console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
            ...
            var B, Fc, ja, aa;
            !0 === this.autoClear ? this.clear() : q.setTransform(1, 0, 0, -1, p, o);
            ...
            if (!0 === wb) {
                ...
                fb.setRGB(0, 0, 0);
                B = 0;
                for (Fc = i.length; B < Fc; B++) {
                    aa = i[B];
                    var z = aa.color;
                    aa instanceof THREE.AmbientLight ? (Da.r += z.r, Da.g += z.g, Da.b += z.b) : aa instanceof THREE.DirectionalLight ? (qb.r += z.r, qb.g += z.g, qb.b += z.b) : aa instanceof THREE.PointLight && (fb.r += z.r, fb.g += z.g, fb.b += z.b)
                }
            }
            B = 0;
            for (Fc = h.length; B < Fc; B++) if (ja = h[B], aa = ja.material, !(void 0 === aa || !1 === aa.visible)) {
                wa.empty();
                if (ja instanceof THREE.RenderableParticle) {
                    ...
                    var rb = void 0,
                        ...
                        kc = ja = void 0,
                        Uc = void 0;
                    aa instanceof THREE.ParticleBasicMaterial ? null === aa.map ? (jb = Xa.object.scale.x, kb = Xa.object.scale.y, jb *= Xa.scale.x * p, kb *= Xa.scale.y * o, wa.set(z.x - jb, z.y - kb, z.x + jb, z.y + kb), !1 !== $a.intersects(wa) && (e(aa.color.getContextStyle()),
                    q.save(), q.translate(z.x, z.y), q.rotate(-Xa.rotation), q.scale(jb, kb), q.fillRect(-1, -1, 2, 2), q.restore())) : (ja = aa.map.image, kc = ja.width >> 1, Uc = ja.height >> 1, jb = Xa.scale.x * p, kb = Xa.scale.y * o, rb = jb * kc, sb = kb * Uc, wa.set(z.x - rb, z.y - sb, z.x + rb, z.y + sb), !1 !== $a.intersects(wa) && (q.save(), q.translate(z.x, z.y), q.rotate(-Xa.rotation), q.scale(jb, -kb), q.translate(-kc, -Uc), q.drawImage(ja, 0, 0), q.restore())) : aa instanceof THREE.ParticleCanvasMaterial && (rb = Xa.scale.x * p, sb = Xa.scale.y * o, wa.set(z.x - rb, z.y - sb, z.x + rb, z.y + sb), !1 !== $a.intersects(wa) && (d(aa.color.getContextStyle()), e(aa.color.getContextStyle()), q.save(), q.translate(z.x, z.y), q.rotate(-Xa.rotation), q.scale(rb, sb), aa.program(q), q.restore()))
                } else if (ja instanceof THREE.RenderableLine) {
                    if (C = ja.v1, G = ja.v2, C.positionScreen.x *= p, C.positionScreen.y *= o, G.positionScreen.x *= p, G.positionScreen.y *= o, wa.addPoint(C.positionScreen.x, C.positionScreen.y), wa.addPoint(G.positionScreen.x, G.positionScreen.y), !0 === $a.intersects(wa) && (z = C, Xa = G, b(aa.opacity), c(aa.blending), q.beginPath(),
                    q.moveTo(z.positionScreen.x, z.positionScreen.y), q.lineTo(Xa.positionScreen.x, Xa.positionScreen.y), aa instanceof THREE.LineBasicMaterial)) z = aa.linewidth, A !== z && (A = q.lineWidth = z), z = aa.linecap, v !== z && (v = q.lineCap = z), z = aa.linejoin, y !== z && (y = q.lineJoin = z), d(aa.color.getContextStyle()), q.stroke(), wa.inflate(2 * aa.linewidth)
                } else if (ja instanceof THREE.RenderableFace3) C = ja.v1, G = ja.v2, H = ja.v3, C.positionScreen.x *= p, C.positionScreen.y *= o, G.positionScreen.x *= p, G.positionScreen.y *= o, H.positionScreen.x *= p, H.positionScreen.y *= o, !0 === aa.overdraw && (Wb(C.positionScreen, G.positionScreen), Wb(G.positionScreen, H.positionScreen), Wb(H.positionScreen, C.positionScreen)), wa.add3Points(C.positionScreen.x, C.positionScreen.y, G.positionScreen.x, G.positionScreen.y, H.positionScreen.x, H.positionScreen.y), !0 === $a.intersects(wa) && n(C, G, H, 0, 1, 2, ja, aa, a);
                else if (ja instanceof THREE.RenderableFace4 && (C = ja.v1, G = ja.v2, H = ja.v3, J = ja.v4, C.positionScreen.x *= p, C.positionScreen.y *= o, G.positionScreen.x *= p, G.positionScreen.y *= o, H.positionScreen.x *= p, H.positionScreen.y *= o, J.positionScreen.x *= p, J.positionScreen.y *= o, E.positionScreen.copy(G.positionScreen), M.positionScreen.copy(J.positionScreen), !0 === aa.overdraw && (Wb(C.positionScreen, G.positionScreen), Wb(G.positionScreen, J.positionScreen), Wb(J.positionScreen, C.positionScreen), Wb(H.positionScreen, E.positionScreen), Wb(H.positionScreen, M.positionScreen)), wa.addPoint(C.positionScreen.x, C.positionScreen.y), wa.addPoint(G.positionScreen.x, G.positionScreen.y), wa.addPoint(H.positionScreen.x, H.positionScreen.y), wa.addPoint(J.positionScreen.x,
                ...
                Ia, Ua), na = Dc(fa, W, V, ia), r(K, F, I, L, Y, N), gc(K, F, I, L, Y, N, 0, 0, 1, 0, 0, 1, na), r(ea, Q, R, $, qa, la), gc(ea, Q, R, $, qa, la, 1, 0, 1, 1, 0, 1, na));
                Ja.addRectangle(wa)
            }
...
THREE.ShaderLib = {
    ...
    depthRGBA: {
        uniforms: {},
        vertexShader: [THREE.ShaderChunk.morphtarget_pars_vertex, THREE.ShaderChunk.skinning_pars_vertex, "void main() {",
...
THREE.WebGLRenderer = function (a) {
    ...
    function f(a) {
        var b,
        c, d;
        for (b in a.attributes) d = "index" === b ? k.ELEMENT_ARRAY_BUFFER : k.ARRAY_BUFFER, c = a.attributes[b], c.buffer = k.createBuffer(), k.bindBuffer(d, c.buffer), k.bufferData(d, c.array, k.STATIC_DRAW)
    }
    function g(a, b, c) {
        ...
        if (c.sortParticles) {
            ...
            for (d = 0; d < g; d++) e = h[d], Za.copy(e), gb.multiplyVector3(Za),
            m[d] = [Za.z, d];
            m.sort(function (a, b) {
                return b[0] - a[0]
            });
            for (d = 0; d < g; d++) e = h[m[d][1]], f = 3 * d, l[f] = e.x, l[f + 1] = e.y, l[f + 2] = e.z;
            for (d = 0; d < j; d++) f = 3 * d, e = i[m[d][1]], n[f] = e.r, n[f + 1] = e.g, n[f + 2] = e.b;
            if (q) {
                i = 0;
                for (j = q.length; i < j; i++) if (h = q[i], void 0 === h.boundTo || "vertices" === h.boundTo) if (f = 0, e = h.value.length, 1 === h.size) for (d = 0; d < e; d++) g = m[d][1], h.array[d] = h.value[g];
            ...
            if (o) for (d = 0; d < g; d++) e = h[d], f = 3 * d, l[f] = e.x, l[f + 1] = e.y, l[f + 2] = e.z;
            if (p) for (d = 0; d < j; d++) e = i[d], f = 3 * d, n[f] = e.r, n[f + 1] = e.g, n[f + 2] = e.b;
            if (q) {
                i = 0;
                for (j = q.length; i < j; i++) if (h = q[i], h.needsUpdate && (void 0 === h.boundTo || "vertices" === h.boundTo)) if (e = h.value.length, f = 0, 1 === h.size) for (d = 0; d < e; d++) h.array[d] = h.value[d];
        ...
        if (o || c.sortParticles) k.bindBuffer(k.ARRAY_BUFFER, a.__webglVertexBuffer), k.bufferData(k.ARRAY_BUFFER, l, b);
        if (p || c.sortParticles) k.bindBuffer(k.ARRAY_BUFFER, a.__webglColorBuffer), k.bufferData(k.ARRAY_BUFFER, n, b);
        if (q) {
            i = 0;
            for (j = q.length; i < j; i++) if (h = q[i], h.needsUpdate || c.sortParticles) k.bindBuffer(k.ARRAY_BUFFER, h.buffer), k.bufferData(k.ARRAY_BUFFER, h.array, b)
        }
    }
    function h(a, b, c) {
        var d = a.attributes,
            ...
            i = d.color,
            d = d.tangent;
        a.elementsNeedUpdate && void 0 !== f && (k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, f.buffer), k.bufferData(k.ELEMENT_ARRAY_BUFFER, f.array, b));
        a.verticesNeedUpdate && void 0 !== e && (k.bindBuffer(k.ARRAY_BUFFER, e.buffer), k.bufferData(k.ARRAY_BUFFER, e.array, b));
    ...
    function l(a, b, c) {
        if (a.length) for (var d = 0, f = a.length; d < f; d++) ia = O = null, W = V = Pa = Ga = Ra = ib = Ia = -1, Ea = !0, a[d].render(b, c, Da, qb), ia = O = null, W = V = Pa = Ga = Ra = ib = Ia = -1, Ea = !0
    }
    function m(a, b, c, d, f, e, g, h) {
        var k, i, j, l;
        b ? (i = a.length - 1, l = b = -1) : (i = 0, b = a.length, l = 1);
        for (var n = i; n !== b; n += l) if (k = a[n], k.render) {
            i = k.object;
            j = k.buffer;
            if (h) k = h;
            else {
                k = k[c];
                if (!k) continue;
                g && Q.setBlending(k.blending, k.blendEquation, k.blendSrc, k.blendDst);
                Q.setDepthTest(k.depthTest);
                Q.setDepthWrite(k.depthWrite);
                v(k.polygonOffset, k.polygonOffsetFactor, k.polygonOffsetUnits)
            }
            Q.setMaterialFaces(k);
            j instanceof THREE.BufferGeometry ? Q.renderBufferDirect(d, f, e, k, j, i) : Q.renderBuffer(d, f, e, k, j, i)
        }
    }
    function n(a, b, c, d, f, e, g) {
        for (var h, k, i = 0, j = a.length; i < j; i++) if (h = a[i], k = h.object, k.visible) {
            if (g) h = g;
            else {
                h = h[b];
                if (!h) continue;
                e && Q.setBlending(h.blending, h.blendEquation, h.blendSrc, h.blendDst);
                Q.setDepthTest(h.depthTest);
                Q.setDepthWrite(h.depthWrite);
                v(h.polygonOffset, h.polygonOffsetFactor, h.polygonOffsetUnits)
            }
            Q.renderImmediateObject(c, d, f, h, k)
        }
    }
    function p(a, b, c) {
        a.push({
    ...
    function B(a, b, c, d, f) {
        ca = 0;
        d.needsUpdate && (d.program && Q.deallocateMaterial(d), Q.initMaterial(d, b, c, f), d.needsUpdate = !1);
        d.morphTargets && !f.__webglMorphTargetInfluences && (f.__webglMorphTargetInfluences = new Float32Array(Q.maxMorphTargets));
        var e = !1,
            g = d.program,
            h = g.uniforms,
            i = d.uniforms;
        g !== O && (k.useProgram(g), O = g, e = !0);
        d.id !== W && (W = d.id, e = !0);
        if (e || a !== ia) k.uniformMatrix4fv(h.projectionMatrix, !1, a._projectionMatrixArray), a !== ia && (ia = a);
        if (d.skinning) if (ic && f.useVertexTexture) {
            if (null !== h.boneTexture) {
                var j = u();
                k.uniform1i(h.boneTexture, j);
                Q.setTexture(f.boneTexture, j)
            }
        } else null !== h.boneGlobalMatrices && k.uniformMatrix4fv(h.boneGlobalMatrices, !1, f.boneMatrices);
        if (e) {
            ...
            if (d instanceof THREE.MeshPhongMaterial || d instanceof THREE.MeshLambertMaterial || d.lights) {
                if (Ea) {
                    for (var l = 0, n = 0, m = 0, o, p, q, r, s = xb, t = s.directional.colors, v = s.directional.positions, y = s.point.colors, B = s.point.positions, C = s.point.distances, H = s.spot.colors, J = s.spot.positions, I = s.spot.distances, K = s.spot.directions, F = s.spot.angles, L = s.spot.exponents, N = s.hemi.skyColors, V = s.hemi.groundColors, Z = s.hemi.positions, fa = 0, R = 0, ea = 0, $ = 0, c = o = q = q = p = 0, e = b.length; c < e; c++) j = b[c], !j.onlyShadow && j.visible && (o = j.color, r = j.intensity, p = j.distance, j instanceof THREE.AmbientLight ? Q.gammaInput ? (l += o.r * o.r, n += o.g * o.g, m += o.b * o.b) : (l += o.r, n += o.g, m += o.b) : j instanceof THREE.DirectionalLight ? (p = 3 * fa, Q.gammaInput ? z(t, p, o, r * r) : A(t, p, o, r), Wa.copy(j.matrixWorld.getPosition()), Wa.subSelf(j.target.matrixWorld.getPosition()), Wa.normalize(), v[p] = Wa.x, v[p + 1] = Wa.y, v[p + 2] = Wa.z, fa += 1) : j instanceof THREE.PointLight ? (q = 3 * R, Q.gammaInput ? z(y, q, o, r * r) : A(y, q, o, r), r = j.matrixWorld.getPosition(), B[q] = r.x, B[q + 1] = r.y, B[q + 2] = r.z, C[R] = p, R += 1) : j instanceof THREE.SpotLight ? (q = 3 * ea, Q.gammaInput ? z(H, q, o, r * r) : A(H, q, o, r), r = j.matrixWorld.getPosition(), J[q] = r.x, J[q + 1] = r.y, J[q + 2] = r.z, I[ea] = p, Wa.copy(r), Wa.subSelf(j.target.matrixWorld.getPosition()), Wa.normalize(), K[q] = Wa.x, K[q + 1] = Wa.y, K[q + 2] = Wa.z, F[ea] = Math.cos(j.angle), L[ea] = j.exponent, ea += 1) : j instanceof THREE.HemisphereLight && (p = j.color, q = j.groundColor, o = 3 * $, Q.gammaInput ? (r *= r, z(N, o, p, r), z(V, o, q, r)) : (A(N, o, p, r), A(V, o, q, r)), r = j.matrixWorld.getPosition(), Z[o] = r.x, Z[o + 1] = r.y, Z[o + 2] = r.z, $ += 1));
                    c = 3 * fa;
                    for (e = t.length; c < e; c++) t[c] = 0;
                    c = 3 * R;
                    for (e = y.length; c < e; c++) y[c] = 0;
                    c = 3 * ea;
                    for (e = H.length; c < e; c++) H[c] = 0;
                    c = 3 * $;
                    for (e = N.length; c < e; c++) N[c] = 0;
                    c = 3 * $;
                    for (e = V.length; c < e; c++) V[c] = 0;
                    s.directional.length = fa;
                    s.point.length = R;
                    s.spot.length = ea;
                    s.hemi.length = $;
                    s.ambient[0] = l;
            ...
            if (d instanceof THREE.MeshBasicMaterial || d instanceof THREE.MeshLambertMaterial || d instanceof THREE.MeshPhongMaterial) {
                ...
                Q.gammaInput ? i.diffuse.value.copyGammaToLinear(d.color) : i.diffuse.value = d.color;
                i.map.value = d.map;
            ...
            if (f.receiveShadow && !d._shadowPass && i.shadowMatrix) {
                c = Y = 0;
                for (e = b.length; c < e; c++) if (j = b[c], j.castShadow && (j instanceof THREE.SpotLight || j instanceof THREE.DirectionalLight && !j.shadowCascade)) i.shadowMap.value[Y] = j.shadowMap, i.shadowMapSize.value[Y] = j.shadowMapSize, i.shadowMatrix.value[Y] = j.shadowMatrix, i.shadowDarkness.value[Y] = j.shadowDarkness, i.shadowBias.value[Y] = j.shadowBias, Y++
            }
            b = d.uniformsList;
            i = 0;
            for (Y = b.length; i < Y; i++) if (e = g.uniforms[b[i][1]]) if (c = b[i][0], l = c.type, j = c.value, "i" === l) k.uniform1i(e, j);
            else if ("f" === l) k.uniform1f(e, j);
            else if ("v2" === l) k.uniform2f(e, j.x, j.y);
            else if ("v3" === l) k.uniform3f(e, j.x, j.y, j.z);
            else if ("v4" === l) k.uniform4f(e, j.x, j.y, j.z, j.w);
            else if ("c" === l) k.uniform3f(e, j.r, j.g, j.b);
            else if ("iv1" === l) k.uniform1iv(e,
            j);
            else if ("iv" === l) k.uniform3iv(e, j);
            else if ("fv1" === l) k.uniform1fv(e, j);
            else if ("fv" === l) k.uniform3fv(e, j);
            else if ("v2v" === l) {
                void 0 === c._array && (c._array = new Float32Array(2 * j.length));
                l = 0;
                for (n = j.length; l < n; l++) m = 2 * l, c._array[m] = j[l].x, c._array[m + 1] = j[l].y;
                k.uniform2fv(e, c._array)
            } else if ("v3v" === l) {
                void 0 === c._array && (c._array = new Float32Array(3 * j.length));
                l = 0;
                for (n = j.length; l < n; l++) m = 3 * l, c._array[m] = j[l].x, c._array[m + 1] = j[l].y, c._array[m + 2] = j[l].z;
                k.uniform3fv(e, c._array)
            } else if ("v4v" === l) {
                void 0 === c._array && (c._array = new Float32Array(4 * j.length));
                l = 0;
                for (n = j.length; l < n; l++) m = 4 * l, c._array[m] = j[l].x, c._array[m + 1] = j[l].y, c._array[m + 2] = j[l].z, c._array[m + 3] = j[l].w;
                k.uniform4fv(e, c._array)
            } else if ("m4" === l) void 0 === c._array && (c._array = new Float32Array(16)), j.flattenToArray(c._array), k.uniformMatrix4fv(e, !1, c._array);
            else if ("m4v" === l) {
                void 0 === c._array && (c._array = new Float32Array(16 * j.length));
                l = 0;
                for (n = j.length; l < n; l++) j[l].flattenToArrayOffset(c._array, 16 * l);
                k.uniformMatrix4fv(e, !1, c._array)
            } else if ("t" === l) {
                if (m = j, j = u(), k.uniform1i(e, j), m) if (m.image instanceof Array && 6 === m.image.length) {
                    if (c = m, e = j, 6 === c.image.length) if (c.needsUpdate) {
                        ...
                        e = c instanceof THREE.CompressedTexture;
                        j = [];
                        for (l = 0; 6 > l; l++) Q.autoScaleCubemaps && !e ? (n = j, m = l, s = c.image[l], v = Tc, s.width <= v && s.height <= v || (y = Math.max(s.width, s.height),
                        t = Math.floor(s.width * v / y), v = Math.floor(s.height * v / y), y = document.createElement("canvas"), y.width = t, y.height = v, y.getContext("2d").drawImage(s, 0, 0, s.width, s.height, 0, 0, t, v), s = y), n[m] = s) : j[l] = c.image[l];
                        l = j[0];
                        n = 0 === (l.width & l.width - 1) && 0 === (l.height & l.height - 1);
                        m = E(c.format);
                        s = E(c.type);
                        G(k.TEXTURE_CUBE_MAP, c, n);
                        for (l = 0; 6 > l; l++) if (e) {
                            v = j[l].mipmaps;
                            y = 0;
                            for (B = v.length; y < B; y++) t = v[y], k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X + l, y, m, t.width, t.height, 0, t.data)
                        } else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X + l, 0, m, m, s, j[l]);
                        c.generateMipmaps && n && k.generateMipmap(k.TEXTURE_CUBE_MAP);
                        c.needsUpdate = !1;
                        if (c.onUpdate) c.onUpdate()
                    } else k.activeTexture(k.TEXTURE0 + e), k.bindTexture(k.TEXTURE_CUBE_MAP, c.image.__webglTextureCube)
                } else m instanceof THREE.WebGLRenderTargetCube ? (c = m, k.activeTexture(k.TEXTURE0 + j), k.bindTexture(k.TEXTURE_CUBE_MAP, c.__webglTexture)) : Q.setTexture(m, j)
            } else if ("tv" === l) {
                void 0 === c._array && (c._array = []);
                l = 0;
                for (n = c.value.length; l < n; l++) c._array[l] = u();
                k.uniform1iv(e, c._array);
                l = 0;
                for (n = c.value.length; l < n; l++) m = c.value[l], j = c._array[l], m && Q.setTexture(m, j)
            }
            if ((d instanceof THREE.ShaderMaterial || d instanceof THREE.MeshPhongMaterial || d.envMap) && null !== h.cameraPosition) b = a.matrixWorld.getPosition(), k.uniform3f(h.cameraPosition, b.x, b.y, b.z);
            (d instanceof THREE.MeshPhongMaterial || d instanceof THREE.MeshLambertMaterial || d instanceof THREE.ShaderMaterial || d.skinning) && null !== h.viewMatrix && k.uniformMatrix4fv(h.viewMatrix, !1, a._viewMatrixArray)
        }
        k.uniformMatrix4fv(h.modelViewMatrix, !1, f._modelViewMatrix.elements);
        h.normalMatrix && k.uniformMatrix3fv(h.normalMatrix, !1, f._normalMatrix.elements);
        null !== h.modelMatrix && k.uniformMatrix4fv(h.modelMatrix, !1, f.matrixWorld.elements);
        return g
    }
    function u() {
        var a = ca;
        a >= rc && console.warn("Trying to use " + a + " texture units while this GPU supports only " + rc);
        ca += 1;
        return a
    }
    function s(a, b) {
    ...
    function v(a, b, c) {
        eb !== a && (a ? k.enable(k.POLYGON_OFFSET_FILL) : k.disable(k.POLYGON_OFFSET_FILL), eb = a);
        if (a && (pb !== b || Pb !== c)) k.polygonOffset(b, c), pb = b, Pb = c
    }
    function y(a) {
    ...
    function C(a, b) {
        ...
        k.shaderSource(c, b);
        k.compileShader(c);
        return !k.getShaderParameter(c,
        k.COMPILE_STATUS) ? (console.error(k.getShaderInfoLog(c)), console.error(y(b)), null) : c
    }
    function G(a, b, c) {
        c ? (k.texParameteri(a, k.TEXTURE_WRAP_S, E(b.wrapS)), k.texParameteri(a, k.TEXTURE_WRAP_T, E(b.wrapT)), k.texParameteri(a, k.TEXTURE_MAG_FILTER, E(b.magFilter)), k.texParameteri(a, k.TEXTURE_MIN_FILTER, E(b.minFilter))) : (k.texParameteri(a, k.TEXTURE_WRAP_S, k.CLAMP_TO_EDGE), k.texParameteri(a, k.TEXTURE_WRAP_T, k.CLAMP_TO_EDGE), k.texParameteri(a, k.TEXTURE_MAG_FILTER, J(b.magFilter)), k.texParameteri(a, k.TEXTURE_MIN_FILTER,
        J(b.minFilter)));
        if (Qb && b.type !== THREE.FloatType && (1 < b.anisotropy || b.__oldAnisotropy)) k.texParameterf(a, Qb.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(b.anisotropy, Ec)), b.__oldAnisotropy = b.anisotropy
    }
    function H(a, b) {
        k.bindRenderbuffer(k.RENDERBUFFER, a);
        b.depthBuffer && !b.stencilBuffer ? (k.renderbufferStorage(k.RENDERBUFFER, k.DEPTH_COMPONENT16, b.width, b.height), k.framebufferRenderbuffer(k.FRAMEBUFFER, k.DEPTH_ATTACHMENT, k.RENDERBUFFER, a)) : b.depthBuffer && b.stencilBuffer ? (k.renderbufferStorage(k.RENDERBUFFER, k.DEPTH_STENCIL,
        b.width, b.height), k.framebufferRenderbuffer(k.FRAMEBUFFER, k.DEPTH_STENCIL_ATTACHMENT, k.RENDERBUFFER, a)) : k.renderbufferStorage(k.RENDERBUFFER, k.RGBA4, b.width, b.height)
    }
    function J(a) {
    ...
    function E(a) {
        ...
        if (void 0 !== yb) {
            if (a === THREE.RGB_S3TC_DXT1_Format) return yb.COMPRESSED_RGB_S3TC_DXT1_EXT;
            if (a === THREE.RGBA_S3TC_DXT1_Format) return yb.COMPRESSED_RGBA_S3TC_DXT1_EXT;
            if (a === THREE.RGBA_S3TC_DXT3_Format) return yb.COMPRESSED_RGBA_S3TC_DXT3_EXT;
            if (a === THREE.RGBA_S3TC_DXT5_Format) return yb.COMPRESSED_RGBA_S3TC_DXT5_EXT
        }
        return 0
    }
    console.log("THREE.WebGLRenderer", THREE.REVISION);
    var a = a || {}, M = void 0 !== a.canvas ? a.canvas : document.createElement("canvas"),
        K = void 0 !== a.precision ? a.precision : "highp",
        F = void 0 !== a.alpha ? a.alpha : !0,
        I = void 0 !== a.premultipliedAlpha ? a.premultipliedAlpha : !0,
        L = void 0 !== a.antialias ? a.antialias : !1,
        R = void 0 !== a.stencil ? a.stencil : !0,
        $ = void 0 !== a.preserveDrawingBuffer ? a.preserveDrawingBuffer : !1,
        Y = void 0 !== a.clearColor ? new THREE.Color(a.clearColor) : new THREE.Color(0),
        N = void 0 !== a.clearAlpha ? a.clearAlpha : 0,
        ea = void 0 !== a.maxLights ? a.maxLights : 4;
    this.domElement = M;
    this.context = null;
    ...
    F = k.getExtension("OES_standard_derivatives");
    Qb = k.getExtension("EXT_texture_filter_anisotropic") || k.getExtension("MOZ_EXT_texture_filter_anisotropic") || k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
    yb = k.getExtension("WEBGL_compressed_texture_s3tc") || k.getExtension("MOZ_WEBGL_compressed_texture_s3tc") || k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");
    a || console.log("THREE.WebGLRenderer: Float textures not supported.");
    F || console.log("THREE.WebGLRenderer: Standard derivatives not supported.");
    Qb || console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");
    yb || console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");
    ...
    k.clearColor(Y.r, Y.g, Y.b, N);
    this.context = k;
    var rc = k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),
        F = k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);
    k.getParameter(k.MAX_TEXTURE_SIZE);
    var Tc = k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),
        Ec = Qb ? k.getParameter(Qb.MAX_TEXTURE_MAX_ANISOTROPY_EXT) : 0,
        hc = 0 < F,
        ic = hc && a;
    ...
    this.setViewport = function (a, b, c, d) {
        $a = void 0 !== a ? a : 0;
        Ja = void 0 !== b ? b : 0;
        wa = void 0 !== c ? c : M.width;
        wb = void 0 !== d ? d : M.height;
        k.viewport($a, Ja, wa, wb)
    };
    ...
    this.deallocateObject = function (a) {
        if (a.__webglInit) if (a.__webglInit = !1, delete a._modelViewMatrix, delete a._normalMatrix, delete a._normalMatrixArray, delete a._modelViewMatrixArray, delete a._modelMatrixArray,
        a instanceof THREE.Mesh) for (var b in a.geometry.geometryGroups) {
            ...
            if (c.__webglCustomAttributesList) for (d in d = void 0, c.__webglCustomAttributesList) k.deleteBuffer(c.__webglCustomAttributesList[d].buffer);
            Q.info.memory.geometries--
        } else a instanceof THREE.Ribbon ? (a = a.geometry, k.deleteBuffer(a.__webglVertexBuffer), k.deleteBuffer(a.__webglColorBuffer), Q.info.memory.geometries--) : a instanceof
        THREE.Line ? (a = a.geometry, k.deleteBuffer(a.__webglVertexBuffer), k.deleteBuffer(a.__webglColorBuffer), Q.info.memory.geometries--) : a instanceof THREE.ParticleSystem && (a = a.geometry, k.deleteBuffer(a.__webglVertexBuffer), k.deleteBuffer(a.__webglColorBuffer), Q.info.memory.geometries--)
    };
    this.deallocateTexture = function (a) {
        a.__webglInit && (a.__webglInit = !1, k.deleteTexture(a.__webglTexture), Q.info.memory.textures--)
    };
    this.deallocateRenderTarget = function (a) {
        if (a && a.__webglTexture) if (k.deleteTexture(a.__webglTexture),
    ...
    this.deallocateMaterial = function (a) {
        ...
        if (b) {
            ...
            var c, d, e = !1,
                a = 0;
            for (c = qa.length; a < c; a++) if (d = qa[a], d.program === b) {
                d.usedTimes--;
                0 === d.usedTimes && (e = !0);
                break
            }
            if (e) {
                e = [];
                a = 0;
                for (c = qa.length; a < c; a++) d = qa[a], d.program !== b && e.push(d);
                qa = e;
                k.deleteProgram(b);
    ...
    this.renderBufferImmediate = function (a, b, c) {
        ...
        if (a.hasNormals) {
            ...
            if (c.shading === THREE.FlatShading) {
                ...
                for (o = 0; o < p; o += 9) m = a.normalArray, d = m[o], e = m[o + 1], f = m[o + 2], g = m[o + 3], i = m[o + 4], l = m[o + 5], h = m[o + 6], j = m[o + 7], n = m[o + 8], d = (d + g + h) / 3, e = (e + i + j) / 3, f = (f + l + n) / 3, m[o] = d, m[o + 1] = e, m[o + 2] = f, m[o + 3] = d, m[o + 4] = e, m[o + 5] = f, m[o + 6] = d, m[o + 7] = e, m[o + 8] = f
            }
        ...
        a.hasUvs && c.map && (k.bindBuffer(k.ARRAY_BUFFER, a.__webglUvBuffer), k.bufferData(k.ARRAY_BUFFER, a.uvArray, k.DYNAMIC_DRAW), k.enableVertexAttribArray(b.attributes.uv), k.vertexAttribPointer(b.attributes.uv, 2, k.FLOAT, !1, 0, 0));
    ...
    this.renderBufferDirect = function (a, b, c, d, e, f) {
        if (!1 !== d.visible) if (c = B(a, b, c, d, f), a = c.attributes, b = !1, d = 16777215 * e.id + 2 * c.id + (d.wireframe ? 1 : 0), d !== V && (V = d, b = !0), f instanceof THREE.Mesh) {
            f = e.offsets;
            1 < f.length && (b = !0);
            d = 0;
            for (c = f.length; d < c; ++d) {
                ...
                if (b) {
                    ...
                    h = e.attributes.uv;
                    0 <= a.uv && h && (h.buffer ? (i = h.itemSize, k.bindBuffer(k.ARRAY_BUFFER, h.buffer), k.vertexAttribPointer(a.uv, i, k.FLOAT, !1, 0, 4 * g * i), k.enableVertexAttribArray(a.uv)) : k.disableVertexAttribArray(a.uv));
                ...
                Q.info.render.faces += f[d].count / 3
            }
        } else f instanceof THREE.ParticleSystem && b && (h = e.attributes.position, i = h.itemSize, k.bindBuffer(k.ARRAY_BUFFER, h.buffer), k.vertexAttribPointer(a.position, i, k.FLOAT, !1, 0, 0), i = e.attributes.color, 0 <= a.color && i && (j = i.itemSize, k.bindBuffer(k.ARRAY_BUFFER, i.buffer), k.vertexAttribPointer(a.color, j, k.FLOAT, !1, 0, 0)), k.drawArrays(k.POINTS, 0, h.numItems / 3), Q.info.render.calls++, Q.info.render.points += h.numItems / 3)
    };
    this.renderBuffer = function (a, b, c, d, e, f) {
        if (!1 !== d.visible) {
            ...
            c !== V && (V = c, a = !0);
            if (!d.morphTargets && 0 <= b.position) a && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglVertexBuffer), k.vertexAttribPointer(b.position, 3, k.FLOAT, !1, 0, 0));
            else if (f.morphTargetBase) {
                c = d.program.attributes; - 1 !== f.morphTargetBase ? (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[f.morphTargetBase]), k.vertexAttribPointer(c.position, 3, k.FLOAT, !1, 0, 0)) : 0 <= c.position && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglVertexBuffer),
                k.vertexAttribPointer(c.position, 3, k.FLOAT, !1, 0, 0));
                if (f.morphTargetForcedOrder.length) {
                    var i = 0;
                    h = f.morphTargetForcedOrder;
                    for (g = f.morphTargetInfluences; i < d.numSupportedMorphTargets && i < h.length;) k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[h[i]]), k.vertexAttribPointer(c["morphTarget" + i], 3, k.FLOAT, !1, 0, 0), d.morphNormals && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[h[i]]), k.vertexAttribPointer(c["morphNormal" + i], 3, k.FLOAT, !1, 0, 0)), f.__webglMorphTargetInfluences[i] = g[h[i]],
                    i++
                } else {
                    h = [];
                    g = f.morphTargetInfluences;
                    var l, m = g.length;
                    for (l = 0; l < m; l++) i = g[l], 0 < i && h.push([l, i]);
                    ...
                    for (i = 0; i < d.numSupportedMorphTargets;) h[i] ? (l = h[i][0], k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[l]), k.vertexAttribPointer(c["morphTarget" + i], 3, k.FLOAT, !1, 0, 0), d.morphNormals && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[l]),
            ...
            if (a) {
                if (e.__webglCustomAttributesList) {
                    g = 0;
                    for (h = e.__webglCustomAttributesList.length; g < h; g++) c = e.__webglCustomAttributesList[g], 0 <= b[c.buffer.belongsToAttribute] && (k.bindBuffer(k.ARRAY_BUFFER, c.buffer), k.vertexAttribPointer(b[c.buffer.belongsToAttribute], c.size, k.FLOAT, !1, 0, 0))
                }
    ...
    this.render = function (a, b, c, d) {
        if (!1 === b instanceof THREE.Camera) console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
            ...
            ra.multiply(b.projectionMatrix, b.matrixWorldInverse);
            fb.setFromMatrix(ra);
            ...
            h = a.__webglObjects;
            d = 0;
            for (e = h.length; d < e; d++) if (f = h[d], g = f.object, f.render = !1,
            g.visible && (!(g instanceof THREE.Mesh || g instanceof THREE.ParticleSystem) || !g.frustumCulled || fb.contains(g))) {
                s(g, b);
                var p = f,
                    q = p.object,
                    r = p.buffer,
                ...
                f.render = !0;
                !0 === this.sortObjects && (null !== g.renderDepth ? f.z = g.renderDepth : (Za.copy(g.matrixWorld.getPosition()), ra.multiplyVector3(Za), f.z = Za.z))
            }
            this.sortObjects && h.sort(i);
            h = a.__webglObjectsImmediate;
            d = 0;
            for (e = h.length; d < e; d++) f = h[d], g = f.object, g.visible && (s(g, b), g = f.object.material, g.transparent ? (f.transparent = g, f.opaque = null) : (f.opaque = g, f.transparent = null));
            a.overrideMaterial ? (d = a.overrideMaterial, this.setBlending(d.blending, d.blendEquation, d.blendSrc, d.blendDst), this.setDepthTest(d.depthTest), this.setDepthWrite(d.depthWrite), v(d.polygonOffset, d.polygonOffsetFactor,
            d.polygonOffsetUnits), m(a.__webglObjects, !1, "", b, j, o, !0, d), n(a.__webglObjectsImmediate, "", b, j, o, !1, d)) : (this.setBlending(THREE.NormalBlending), m(a.__webglObjects, !0, "opaque", b, j, o, !1), n(a.__webglObjectsImmediate, "opaque", b, j, o, !1), m(a.__webglObjects, !1, "transparent", b, j, o, !0), n(a.__webglObjectsImmediate, "transparent", b, j, o, !0));
            l(this.renderPluginsPost, a, b);
            c && (c.generateMipmaps && c.minFilter !== THREE.NearestFilter && c.minFilter !== THREE.LinearFilter) && (c instanceof THREE.WebGLRenderTargetCube ? (k.bindTexture(k.TEXTURE_CUBE_MAP,
            c.__webglTexture), k.generateMipmap(k.TEXTURE_CUBE_MAP), k.bindTexture(k.TEXTURE_CUBE_MAP, null)) : (k.bindTexture(k.TEXTURE_2D, c.__webglTexture), k.generateMipmap(k.TEXTURE_2D), k.bindTexture(k.TEXTURE_2D, null)));
            this.setDepthTest(!0);
    ...
    this.renderImmediateObject = function (a, b, c, d, e) {
        ...
        e.immediateRenderCallback ? e.immediateRenderCallback(f, k, fb) : e.render(function (a) {
    ...
    this.initWebGLObjects = function (a) {
        ...
        for (; a.__objectsAdded.length;) {
            var i = a.__objectsAdded[0],
                ...
                m = void 0,
                n = void 0;
            if (!i.__webglInit) if (i.__webglInit = !0, i._modelViewMatrix = new THREE.Matrix4, i._normalMatrix = new THREE.Matrix3, i instanceof THREE.Mesh) if (m = i.geometry, m instanceof THREE.Geometry) {
                if (void 0 === m.geometryGroups) {
                    var s = m,
                        ...
                        B = void 0,
                        C = void 0,
                        E = {}, G = s.morphTargets.length,
                        H = s.morphNormals.length;
                    s.geometryGroups = {};
                    u = 0;
                    for (v = s.faces.length; u < v; u++) y = s.faces[u], z = y.materialIndex, B = void 0 !== z ? z : -1, void 0 === E[B] && (E[B] = {
                        hash: B,
                        counter: 0
                    }), C = E[B].hash + "_" + E[B].counter, void 0 === s.geometryGroups[C] && (s.geometryGroups[C] = {
                        faces3: [],
                        faces4: [],
                        materialIndex: z,
                        vertices: 0,
                        numMorphTargets: G,
                        numMorphNormals: H
                    }), A = y instanceof THREE.Face3 ? 3 : 4, 65535 < s.geometryGroups[C].vertices + A && (E[B].counter += 1, C = E[B].hash + "_" + E[B].counter, void 0 === s.geometryGroups[C] && (s.geometryGroups[C] = {
                        faces3: [],
                        faces4: [],
                        materialIndex: z,
                        vertices: 0,
                        numMorphTargets: G,
                        numMorphNormals: H
                    })), y instanceof THREE.Face3 ? s.geometryGroups[C].faces3.push(u) : s.geometryGroups[C].faces4.push(u), s.geometryGroups[C].vertices += A;
                    s.geometryGroupsList = [];
                    var J = void 0;
                    for (J in s.geometryGroups) s.geometryGroups[J].id = Z++, s.geometryGroupsList.push(s.geometryGroups[J])
                }
                for (l in m.geometryGroups) if (n = m.geometryGroups[l], !n.__webglVertexBuffer) {
                    var I = n;
                    ...
                    if (I.numMorphTargets) {
                        ...
                        O = 0;
                        for (K = I.numMorphTargets; O < K; O++) I.__webglMorphTargetsBuffers.push(k.createBuffer())
                    }
                    if (I.numMorphNormals) {
                        I.__webglMorphNormalsBuffers = [];
                        O = 0;
                        for (K = I.numMorphNormals; O < K; O++) I.__webglMorphNormalsBuffers.push(k.createBuffer())
                    }
                    Q.info.memory.geometries++;
                    var F = n,
                        M = i,
                        ...
                        N = F.faces3,
                        W = F.faces4,
                        V = 3 * N.length + 4 * W.length,
                        fa = 1 * N.length + 2 * W.length,
                        ca = 3 * N.length + 4 * W.length,
                        R = c(M, F),
                        Y = e(R),
                        ea = d(R),
                        ia = R.vertexColors ? R.vertexColors : !1;
                    F.__vertexArray = new Float32Array(3 * V);
                    ea && (F.__normalArray = new Float32Array(3 * V));
                    L.hasTangents && (F.__tangentArray = new Float32Array(4 * V));
                    ia && (F.__colorArray = new Float32Array(3 * V));
                    if (Y) {
                        if (0 < L.faceUvs.length || 0 < L.faceVertexUvs.length) F.__uvArray = new Float32Array(2 * V);
                        if (1 < L.faceUvs.length || 1 < L.faceVertexUvs.length) F.__uv2Array = new Float32Array(2 * V)
                    }
                    M.geometry.skinWeights.length && M.geometry.skinIndices.length && (F.__skinIndexArray = new Float32Array(4 * V), F.__skinWeightArray = new Float32Array(4 * V));
                    F.__faceArray = new Uint16Array(3 * fa);
                    F.__lineArray = new Uint16Array(2 * ca);
                    var $ = void 0,
                        qa = void 0;
                    if (F.numMorphTargets) {
                        F.__morphTargetsArrays = [];
                        $ = 0;
                        for (qa = F.numMorphTargets; $ < qa; $++) F.__morphTargetsArrays.push(new Float32Array(3 * V))
                    }
                    if (F.numMorphNormals) {
                        F.__morphNormalsArrays = [];
                        $ = 0;
                        for (qa = F.numMorphNormals; $ < qa; $++) F.__morphNormalsArrays.push(new Float32Array(3 * V))
                    }
                    F.__webglFaceCount = 3 * fa;
                    F.__webglLineCount = 2 * ca;
                    if (R.attributes) {
                        void 0 === F.__webglCustomAttributesList && (F.__webglCustomAttributesList = []);
                        var Ga = void 0;
                        for (Ga in R.attributes) {
                            var na = R.attributes[Ga],
                                la = {}, Pa;
                            for (Pa in na) la[Pa] = na[Pa];
                            if (!la.__webglInitialized || la.createUniqueBuffers) {
                                la.__webglInitialized = !0;
                                var ra = 1;
                                "v2" === la.type ? ra = 2 : "v3" === la.type ? ra = 3 : "v4" === la.type ? ra = 4 : "c" === la.type && (ra = 3);
                                la.size = ra;
                                la.array = new Float32Array(V * ra);
                                la.buffer = k.createBuffer();
                                la.buffer.belongsToAttribute = Ga;
                                na.needsUpdate = !0;
                                la.__original = na
                            }
                            F.__webglCustomAttributesList.push(la)
                        }
                    }
                    F.__inittedArrays = !0;
            ...
            } else m instanceof THREE.BufferGeometry && f(m);
            else if (i instanceof THREE.Ribbon) {
                if (m = i.geometry, !m.__webglVertexBuffer) {
                    var Ia = m;
                    Ia.__webglVertexBuffer = k.createBuffer();
                    Ia.__webglColorBuffer = k.createBuffer();
                    Q.info.memory.geometries++;
                    var wa = m,
                        Da = wa.vertices.length;
                    wa.__vertexArray = new Float32Array(3 * Da);
                    wa.__colorArray = new Float32Array(3 * Da);
                    wa.__webglVertexCount = Da;
                    m.verticesNeedUpdate = !0;
                    m.colorsNeedUpdate = !0
                }
                ...
                if (m = i.geometry, !m.__webglVertexBuffer) {
                    var Ja = m;
                    Ja.__webglVertexBuffer = k.createBuffer();
                    Ja.__webglColorBuffer = k.createBuffer();
                    Q.info.memory.geometries++;
                    var Ea = m,
                        Ua = i,
                        Va = Ea.vertices.length;
                    Ea.__vertexArray = new Float32Array(3 * Va);
                    Ea.__colorArray = new Float32Array(3 * Va);
                    Ea.__webglLineCount = Va;
                    b(Ea, Ua);
                    m.verticesNeedUpdate = !0;
                    m.colorsNeedUpdate = !0
                }
            } else if (i instanceof THREE.ParticleSystem && (m = i.geometry, !m.__webglVertexBuffer)) if (m instanceof THREE.Geometry) {
                var Wa = m;
                Wa.__webglVertexBuffer = k.createBuffer();
                Wa.__webglColorBuffer = k.createBuffer();
                Q.info.memory.geometries++;
                var Ra = m,
                    ib = i,
                    $a = Ra.vertices.length;
                Ra.__vertexArray = new Float32Array(3 * $a);
                Ra.__colorArray = new Float32Array(3 * $a);
                Ra.__sortArray = [];
                Ra.__webglParticleCount = $a;
                b(Ra, ib);
                m.verticesNeedUpdate = !0;
                m.colorsNeedUpdate = !0
            } else m instanceof THREE.BufferGeometry && f(m);
            if (!i.__webglActive) {
                if (i instanceof THREE.Mesh) if (m = i.geometry, m instanceof THREE.BufferGeometry) p(j.__webglObjects, m, i);
                else for (l in m.geometryGroups) n = m.geometryGroups[l], p(j.__webglObjects, n, i);
                else i instanceof THREE.Ribbon || i instanceof THREE.Line || i instanceof THREE.ParticleSystem ? (m = i.geometry, p(j.__webglObjects, m, i)) : i instanceof THREE.ImmediateRenderObject || i.immediateRenderCallback ? j.__webglObjectsImmediate.push({
                    object: i,
                    opaque: null,
                    transparent: null
                }) : i instanceof THREE.Sprite ? j.__webglSprites.push(i) : i instanceof THREE.LensFlare && j.__webglFlares.push(i);
                i.__webglActive = !0
            }
        ...
        for (; a.__objectsRemoved.length;) {
            var lb = a.__objectsRemoved[0],
                Za = a;
            lb instanceof THREE.Mesh || lb instanceof THREE.ParticleSystem || lb instanceof THREE.Ribbon || lb instanceof THREE.Line ? r(Za.__webglObjects, lb) : lb instanceof THREE.Sprite ? t(Za.__webglSprites, lb) : lb instanceof THREE.LensFlare ? t(Za.__webglFlares, lb) : (lb instanceof THREE.ImmediateRenderObject || lb.immediateRenderCallback) && r(Za.__webglObjectsImmediate, lb);
            lb.__webglActive = !1;
            a.__objectsRemoved.splice(0, 1)
        }
        for (var fb = 0, qb = a.__webglObjects.length; fb < qb; fb++) {
            var ub = a.__webglObjects[fb].object,
                ga = ub.geometry,
                gb = void 0,
                eb = void 0,
                ab = void 0;
            if (ub instanceof THREE.Mesh) if (ga instanceof THREE.BufferGeometry)(ga.verticesNeedUpdate || ga.elementsNeedUpdate || ga.uvsNeedUpdate || ga.normalsNeedUpdate || ga.colorsNeedUpdate || ga.tangentsNeedUpdate) && h(ga, k.DYNAMIC_DRAW, !ga.dynamic), ga.verticesNeedUpdate = !1, ga.elementsNeedUpdate = !1, ga.uvsNeedUpdate = !1, ga.normalsNeedUpdate = !1, ga.colorsNeedUpdate = !1, ga.tangentsNeedUpdate = !1;
            else {
                for (var pb = 0, wb = ga.geometryGroupsList.length; pb < wb; pb++) if (gb = ga.geometryGroupsList[pb], ab = c(ub, gb), eb = ab.attributes && o(ab), ga.verticesNeedUpdate || ga.morphTargetsNeedUpdate || ga.elementsNeedUpdate || ga.uvsNeedUpdate || ga.normalsNeedUpdate || ga.colorsNeedUpdate || ga.tangentsNeedUpdate || eb) {
                    var ma = gb,
                        xb = ub,
                        mb = k.DYNAMIC_DRAW,
                        yb = !ga.dynamic,
                        db = ab;
                    if (ma.__inittedArrays) {
                        var Qb = d(db),
                            Pb = db.vertexColors ? db.vertexColors : !1,
                            hc = e(db),
                            Gc = Qb === THREE.SmoothShading,
                            D = void 0,
                            X = void 0,
                            Xb = void 0,
                            P = void 0,
                            ...
                            yc = ma.__uv2Array,
                            ob = ma.__normalArray,
                            xa = ma.__tangentArray,
                            Oa = ma.__colorArray,
                            ya = ma.__skinIndexArray,
                            za = ma.__skinWeightArray,
                            Vc = ma.__morphTargetsArrays,
                            Wc = ma.__morphNormalsArrays,
                            Xc = ma.__webglCustomAttributesList,
                            w = void 0,
                            Ob = ma.__faceArray,
                            hb = ma.__lineArray,
                            bb = xb.geometry,
                            Ec = bb.elementsNeedUpdate,
                            bd = bb.uvsNeedUpdate,
                            Sc = bb.normalsNeedUpdate,
                            Tc = bb.tangentsNeedUpdate,
                            id = bb.colorsNeedUpdate,
                            jd = bb.morphTargetsNeedUpdate,
                            ec = bb.vertices,
                            oa = ma.faces3,
                            pa = ma.faces4,
                            Ta = bb.faces,
                            Yc = bb.faceVertexUvs[0],
                            Zc = bb.faceVertexUvs[1],
                            fc = bb.skinIndices,
                            ac = bb.skinWeights,
                            bc = bb.morphTargets,
                            Ic = bb.morphNormals;
                        if (bb.verticesNeedUpdate) {
                            D = 0;
                            for (X = oa.length; D < X; D++) P = Ta[oa[D]], S = ec[P.a], T = ec[P.b], U = ec[P.c], Na[Ha] = S.x, Na[Ha + 1] = S.y, Na[Ha + 2] = S.z, Na[Ha + 3] = T.x, Na[Ha + 4] = T.y, Na[Ha + 5] = T.z, Na[Ha + 6] = U.x, Na[Ha + 7] = U.y, Na[Ha + 8] = U.z, Ha += 9;
                            D = 0;
                            for (X = pa.length; D < X; D++) P = Ta[pa[D]], S = ec[P.a], T = ec[P.b], U = ec[P.c], ka = ec[P.d], Na[Ha] = S.x, Na[Ha + 1] = S.y, Na[Ha + 2] = S.z, Na[Ha + 3] = T.x, Na[Ha + 4] = T.y, Na[Ha + 5] = T.z, Na[Ha + 6] = U.x, Na[Ha + 7] = U.y, Na[Ha + 8] = U.z, Na[Ha + 9] = ka.x, Na[Ha + 10] = ka.y, Na[Ha + 11] = ka.z, Ha += 12;
                            k.bindBuffer(k.ARRAY_BUFFER, ma.__webglVertexBuffer);
                            k.bufferData(k.ARRAY_BUFFER, Na, mb)
                        }
                        if (jd) {
                            Ma = 0;
                            for (rc = bc.length; Ma < rc; Ma++) {
                                D = ha = 0;
                                for (X = oa.length; D < X; D++) $b = oa[D], P = Ta[$b], S = bc[Ma].vertices[P.a], T = bc[Ma].vertices[P.b], U = bc[Ma].vertices[P.c], Ka = Vc[Ma], Ka[ha] = S.x,
                                ...
                                D = 0;
                                for (X = pa.length; D < X; D++) $b = pa[D], P = Ta[$b], S = bc[Ma].vertices[P.a], T = bc[Ma].vertices[P.b], U = bc[Ma].vertices[P.c], ka = bc[Ma].vertices[P.d], Ka = Vc[Ma],
                                ...
                                k.bindBuffer(k.ARRAY_BUFFER, ma.__webglMorphTargetsBuffers[Ma]);
                                k.bufferData(k.ARRAY_BUFFER, Vc[Ma], mb);
                                db.morphNormals && (k.bindBuffer(k.ARRAY_BUFFER, ma.__webglMorphNormalsBuffers[Ma]), k.bufferData(k.ARRAY_BUFFER, Wc[Ma], mb))
                            }
                        }
                        if (ac.length) {
                            D = 0;
                            for (X = oa.length; D < X; D++) P = Ta[oa[D]], Ib = ac[P.a], Jb = ac[P.b], Kb = ac[P.c], za[da] = Ib.x, za[da + 1] = Ib.y, za[da + 2] = Ib.z, za[da + 3] = Ib.w, za[da + 4] = Jb.x, za[da + 5] = Jb.y, za[da + 6] = Jb.z, za[da + 7] = Jb.w, za[da + 8] = Kb.x, za[da + 9] = Kb.y, za[da + 10] = Kb.z, za[da + 11] = Kb.w, Lb = fc[P.a], Mb = fc[P.b], Nb = fc[P.c], ya[da] = Lb.x, ya[da + 1] = Lb.y, ya[da + 2] = Lb.z, ya[da + 3] = Lb.w,
                            ya[da + 4] = Mb.x, ya[da + 5] = Mb.y, ya[da + 6] = Mb.z, ya[da + 7] = Mb.w, ya[da + 8] = Nb.x, ya[da + 9] = Nb.y, ya[da + 10] = Nb.z, ya[da + 11] = Nb.w, da += 12;
                            D = 0;
                            for (X = pa.length; D < X; D++) P = Ta[pa[D]], Ib = ac[P.a], Jb = ac[P.b], Kb = ac[P.c], vc = ac[P.d], za[da] = Ib.x, za[da + 1] = Ib.y, za[da + 2] = Ib.z, za[da + 3] = Ib.w, za[da + 4] = Jb.x, za[da + 5] = Jb.y, za[da + 6] = Jb.z, za[da + 7] = Jb.w, za[da + 8] = Kb.x, za[da + 9] = Kb.y, za[da + 10] = Kb.z, za[da + 11] = Kb.w, za[da + 12] = vc.x, za[da + 13] = vc.y, za[da + 14] = vc.z, za[da + 15] = vc.w, Lb = fc[P.a], Mb = fc[P.b], Nb = fc[P.c], wc = fc[P.d], ya[da] = Lb.x, ya[da + 1] = Lb.y,
                            ya[da + 2] = Lb.z, ya[da + 3] = Lb.w, ya[da + 4] = Mb.x, ya[da + 5] = Mb.y, ya[da + 6] = Mb.z, ya[da + 7] = Mb.w, ya[da + 8] = Nb.x, ya[da + 9] = Nb.y, ya[da + 10] = Nb.z, ya[da + 11] = Nb.w, ya[da + 12] = wc.x, ya[da + 13] = wc.y, ya[da + 14] = wc.z, ya[da + 15] = wc.w, da += 16;
                            0 < da && (k.bindBuffer(k.ARRAY_BUFFER, ma.__webglSkinIndicesBuffer), k.bufferData(k.ARRAY_BUFFER, ya, mb), k.bindBuffer(k.ARRAY_BUFFER, ma.__webglSkinWeightsBuffer), k.bufferData(k.ARRAY_BUFFER, za, mb))
                        }
                        if (id && Pb) {
                            D = 0;
                            for (X = oa.length; D < X; D++) P = Ta[oa[D]], vb = P.vertexColors, Hc = P.color, 3 === vb.length && Pb === THREE.VertexColors ? (Fb = vb[0], Gb = vb[1], Hb = vb[2]) : Hb = Gb = Fb = Hc, Oa[Fa] = Fb.r, Oa[Fa + 1] = Fb.g, Oa[Fa + 2] = Fb.b, Oa[Fa + 3] = Gb.r, Oa[Fa + 4] = Gb.g, Oa[Fa + 5] = Gb.b, Oa[Fa + 6] = Hb.r, Oa[Fa + 7] = Hb.g, Oa[Fa + 8] = Hb.b, Fa += 9;
                            D = 0;
                            for (X = pa.length; D < X; D++) P = Ta[pa[D]], vb = P.vertexColors, Hc = P.color, 4 === vb.length && Pb === THREE.VertexColors ? (Fb = vb[0], Gb = vb[1], Hb = vb[2], uc = vb[3]) : uc = Hb = Gb = Fb = Hc, Oa[Fa] = Fb.r, Oa[Fa + 1] = Fb.g, Oa[Fa + 2] = Fb.b, Oa[Fa + 3] = Gb.r, Oa[Fa + 4] = Gb.g, Oa[Fa + 5] = Gb.b, Oa[Fa + 6] = Hb.r, Oa[Fa + 7] = Hb.g, Oa[Fa + 8] = Hb.b, Oa[Fa + 9] = uc.r, Oa[Fa + 10] = uc.g,
                            Oa[Fa + 11] = uc.b, Fa += 12;
                            0 < Fa && (k.bindBuffer(k.ARRAY_BUFFER, ma.__webglColorBuffer), k.bufferData(k.ARRAY_BUFFER, Oa, mb))
                        }
                        if (Tc && bb.hasTangents) {
                            D = 0;
                            for (X = oa.length; D < X; D++) P = Ta[oa[D]], Rb = P.vertexTangents, zb = Rb[0], Ab = Rb[1], Bb = Rb[2], xa[ua] = zb.x, xa[ua + 1] = zb.y, xa[ua + 2] = zb.z, xa[ua + 3] = zb.w, xa[ua + 4] = Ab.x, xa[ua + 5] = Ab.y, xa[ua + 6] = Ab.z, xa[ua + 7] = Ab.w, xa[ua + 8] = Bb.x, xa[ua + 9] = Bb.y, xa[ua + 10] = Bb.z, xa[ua + 11] = Bb.w, ua += 12;
                            D = 0;
                            for (X = pa.length; D < X; D++) P = Ta[pa[D]], Rb = P.vertexTangents, zb = Rb[0], Ab = Rb[1], Bb = Rb[2], sc = Rb[3], xa[ua] = zb.x, xa[ua + 1] = zb.y, xa[ua + 2] = zb.z, xa[ua + 3] = zb.w, xa[ua + 4] = Ab.x, xa[ua + 5] = Ab.y, xa[ua + 6] = Ab.z, xa[ua + 7] = Ab.w, xa[ua + 8] = Bb.x, xa[ua + 9] = Bb.y, xa[ua + 10] = Bb.z, xa[ua + 11] = Bb.w, xa[ua + 12] = sc.x, xa[ua + 13] = sc.y, xa[ua + 14] = sc.z, xa[ua + 15] = sc.w, ua += 16;
                            k.bindBuffer(k.ARRAY_BUFFER, ma.__webglTangentBuffer);
                            k.bufferData(k.ARRAY_BUFFER, xa, mb)
                        }
                        if (Sc && Qb) {
                            D = 0;
                            for (X = oa.length; D < X; D++) if (P = Ta[oa[D]], lc = P.vertexNormals, Yb = P.normal, 3 === lc.length && Gc) for (sa = 0; 3 > sa; sa++) Zb = lc[sa], ob[Sa] = Zb.x, ob[Sa + 1] = Zb.y, ob[Sa + 2] = Zb.z, Sa += 3;
                            else for (sa = 0; 3 > sa; sa++) ob[Sa] = Yb.x, ob[Sa + 1] = Yb.y, ob[Sa + 2] = Yb.z, Sa += 3;
                            D = 0;
                            for (X = pa.length; D < X; D++) if (P = Ta[pa[D]], lc = P.vertexNormals, Yb = P.normal, 4 === lc.length && Gc) for (sa = 0; 4 > sa; sa++) Zb = lc[sa], ob[Sa] = Zb.x, ob[Sa + 1] = Zb.y, ob[Sa + 2] = Zb.z, Sa += 3;
                            else for (sa = 0; 4 > sa; sa++) ob[Sa] = Yb.x, ob[Sa + 1] = Yb.y, ob[Sa + 2] = Yb.z, Sa += 3;
                            k.bindBuffer(k.ARRAY_BUFFER, ma.__webglNormalBuffer);
                            k.bufferData(k.ARRAY_BUFFER, ob, mb)
                        }
                        if (bd && Yc && hc) {
                            D = 0;
                            for (X = oa.length; D < X; D++) if (Xb = oa[D], mc = Yc[Xb], void 0 !== mc) for (sa = 0; 3 > sa; sa++) oc = mc[sa], xc[Tb] = oc.u, xc[Tb + 1] = oc.v, Tb += 2;
                            D = 0;
                            for (X = pa.length; D < X; D++) if (Xb = pa[D], mc = Yc[Xb], void 0 !== mc) for (sa = 0; 4 > sa; sa++) oc = mc[sa], xc[Tb] = oc.u, xc[Tb + 1] = oc.v, Tb += 2;
                            0 < Tb && (k.bindBuffer(k.ARRAY_BUFFER, ma.__webglUVBuffer), k.bufferData(k.ARRAY_BUFFER, xc, mb))
                        }
                        if (bd && Zc && hc) {
                            D = 0;
                            for (X = oa.length; D < X; D++) if (Xb = oa[D], nc = Zc[Xb], void 0 !== nc) for (sa = 0; 3 > sa; sa++) pc = nc[sa], yc[Ub] = pc.u, yc[Ub + 1] = pc.v, Ub += 2;
                            D = 0;
                            for (X = pa.length; D < X; D++) if (Xb = pa[D], nc = Zc[Xb], void 0 !== nc) for (sa = 0; 4 > sa; sa++) pc = nc[sa], yc[Ub] = pc.u, yc[Ub + 1] = pc.v, Ub += 2;
                            0 < Ub && (k.bindBuffer(k.ARRAY_BUFFER,
                            ma.__webglUV2Buffer), k.bufferData(k.ARRAY_BUFFER, yc, mb))
                        }
                        if (Ec) {
                            D = 0;
                            for (X = oa.length; D < X; D++) Ob[nb] = Ca, Ob[nb + 1] = Ca + 1, Ob[nb + 2] = Ca + 2, nb += 3, hb[Ya] = Ca, hb[Ya + 1] = Ca + 1, hb[Ya + 2] = Ca, hb[Ya + 3] = Ca + 2, hb[Ya + 4] = Ca + 1, hb[Ya + 5] = Ca + 2, Ya += 6, Ca += 3;
                            D = 0;
                            for (X = pa.length; D < X; D++) Ob[nb] = Ca, Ob[nb + 1] = Ca + 1, Ob[nb + 2] = Ca + 3, Ob[nb + 3] = Ca + 1, Ob[nb + 4] = Ca + 2, Ob[nb + 5] = Ca + 3, nb += 6, hb[Ya] = Ca, hb[Ya + 1] = Ca + 1, hb[Ya + 2] = Ca, hb[Ya + 3] = Ca + 3, hb[Ya + 4] = Ca + 1, hb[Ya + 5] = Ca + 2, hb[Ya + 6] = Ca + 2, hb[Ya + 7] = Ca + 3, Ya += 8, Ca += 4;
                            k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, ma.__webglFaceBuffer);
                            k.bufferData(k.ELEMENT_ARRAY_BUFFER, Ob, mb);
                            k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, ma.__webglLineBuffer);
                            k.bufferData(k.ELEMENT_ARRAY_BUFFER, hb, mb)
                        }
                        if (Xc) {
                            sa = 0;
                            for (ic = Xc.length; sa < ic; sa++) if (w = Xc[sa], w.__original.needsUpdate) {
                                x = 0;
                                if (1 === w.size) if (void 0 === w.boundTo || "vertices" === w.boundTo) {
                                    D = 0;
                                    for (X = oa.length; D < X; D++) P = Ta[oa[D]], w.array[x] = w.value[P.a], w.array[x + 1] = w.value[P.b], w.array[x + 2] = w.value[P.c], x += 3;
                                    D = 0;
                                    for (X = pa.length; D < X; D++) P = Ta[pa[D]], w.array[x] = w.value[P.a], w.array[x + 1] = w.value[P.b], w.array[x + 2] = w.value[P.c], w.array[x + 3] = w.value[P.d], x += 4
                                } else {
                                    if ("faces" === w.boundTo) {
                                        D = 0;
                                        for (X = oa.length; D < X; D++) ta = w.value[oa[D]], w.array[x] = ta, w.array[x + 1] = ta, w.array[x + 2] = ta, x += 3;
                                        D = 0;
                                        for (X = pa.length; D < X; D++) ta = w.value[pa[D]], w.array[x] = ta, w.array[x + 1] = ta, w.array[x + 2] = ta, w.array[x + 3] = ta, x += 4
                                    }
                                } else if (2 === w.size) if (void 0 === w.boundTo || "vertices" === w.boundTo) {
                                    D = 0;
                                    for (X = oa.length; D < X; D++) P = Ta[oa[D]], S = w.value[P.a], T = w.value[P.b], U = w.value[P.c], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = T.x, w.array[x + 3] = T.y,
                                    w.array[x + 4] = U.x, w.array[x + 5] = U.y, x += 6;
                                    D = 0;
                                    for (X = pa.length; D < X; D++) P = Ta[pa[D]], S = w.value[P.a], T = w.value[P.b], U = w.value[P.c], ka = w.value[P.d], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = T.x, w.array[x + 3] = T.y, w.array[x + 4] = U.x, w.array[x + 5] = U.y, w.array[x + 6] = ka.x, w.array[x + 7] = ka.y, x += 8
                                } else {
                                    if ("faces" === w.boundTo) {
                                        D = 0;
                                        for (X = oa.length; D < X; D++) U = T = S = ta = w.value[oa[D]], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = T.x, w.array[x + 3] = T.y, w.array[x + 4] = U.x, w.array[x + 5] = U.y, x += 6;
                                        D = 0;
                                        for (X = pa.length; D < X; D++) ka = U = T = S = ta = w.value[pa[D]], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = T.x, w.array[x + 3] = T.y, w.array[x + 4] = U.x, w.array[x + 5] = U.y, w.array[x + 6] = ka.x, w.array[x + 7] = ka.y, x += 8
                                    }
                                } else if (3 === w.size) {
                                    var ba;
                                    ba = "c" === w.type ? ["r", "g", "b"] : ["x", "y", "z"];
                                    if (void 0 === w.boundTo || "vertices" === w.boundTo) {
                                        D = 0;
                                        for (X = oa.length; D < X; D++) P = Ta[oa[D]], S = w.value[P.a], T = w.value[P.b], U = w.value[P.c], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], x += 9;
                                        D = 0;
                                        for (X = pa.length; D < X; D++) P = Ta[pa[D]], S = w.value[P.a], T = w.value[P.b], U = w.value[P.c], ka = w.value[P.d], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], w.array[x + 9] = ka[ba[0]], w.array[x + 10] = ka[ba[1]], w.array[x + 11] = ka[ba[2]], x += 12
                                    } else if ("faces" === w.boundTo) {
                                        D = 0;
                                        for (X = oa.length; D < X; D++) U = T = S = ta = w.value[oa[D]], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], x += 9;
                                        D = 0;
                                        for (X = pa.length; D < X; D++) ka = U = T = S = ta = w.value[pa[D]], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], w.array[x + 9] = ka[ba[0]], w.array[x + 10] = ka[ba[1]], w.array[x + 11] = ka[ba[2]], x += 12
                                    } else if ("faceVertices" === w.boundTo) {
                                        D = 0;
                                        for (X = oa.length; D < X; D++) ta = w.value[oa[D]], S = ta[0], T = ta[1], U = ta[2], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], x += 9;
                                        D = 0;
                                        for (X = pa.length; D < X; D++) ta = w.value[pa[D]], S = ta[0], T = ta[1], U = ta[2], ka = ta[3], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], w.array[x + 9] = ka[ba[0]], w.array[x + 10] = ka[ba[1]], w.array[x + 11] = ka[ba[2]], x += 12
                                    }
                                } else if (4 === w.size) if (void 0 === w.boundTo || "vertices" === w.boundTo) {
                                    D = 0;
                                    for (X = oa.length; D < X; D++) P = Ta[oa[D]], S = w.value[P.a], T = w.value[P.b], U = w.value[P.c], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x + 9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, x += 12;
                                    D = 0;
                                    for (X = pa.length; D < X; D++) P = Ta[pa[D]], S = w.value[P.a], T = w.value[P.b], U = w.value[P.c], ka = w.value[P.d], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x + 9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, w.array[x + 12] = ka.x, w.array[x + 13] = ka.y, w.array[x + 14] = ka.z, w.array[x + 15] = ka.w, x += 16
                                } else if ("faces" === w.boundTo) {
                                    D = 0;
                                    for (X = oa.length; D < X; D++) U = T = S = ta = w.value[oa[D]], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x + 9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, x += 12;
                                    D = 0;
                                    for (X = pa.length; D < X; D++) ka = U = T = S = ta = w.value[pa[D]], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x + 9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, w.array[x + 12] = ka.x,
                                    w.array[x + 13] = ka.y, w.array[x + 14] = ka.z, w.array[x + 15] = ka.w, x += 16
                                } else if ("faceVertices" === w.boundTo) {
                                    D = 0;
                                    for (X = oa.length; D < X; D++) ta = w.value[oa[D]], S = ta[0], T = ta[1], U = ta[2], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x + 9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, x += 12;
                                    D = 0;
                                    for (X = pa.length; D < X; D++) ta = w.value[pa[D]], S = ta[0], T = ta[1], U = ta[2], ka = ta[3], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x + 9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, w.array[x + 12] = ka.x, w.array[x + 13] = ka.y, w.array[x + 14] = ka.z, w.array[x + 15] = ka.w, x += 16
                                }
                                k.bindBuffer(k.ARRAY_BUFFER, w.buffer);
                                k.bufferData(k.ARRAY_BUFFER, w.array, mb)
                            }
                        }
                        yb && (delete ma.__inittedArrays, delete ma.__colorArray, delete ma.__normalArray, delete ma.__tangentArray, delete ma.__uvArray, delete ma.__uv2Array, delete ma.__faceArray, delete ma.__vertexArray,
                        delete ma.__lineArray, delete ma.__skinIndexArray, delete ma.__skinWeightArray)
                    }
                }
                ...
                if (ga.verticesNeedUpdate || ga.colorsNeedUpdate) {
                    ...
                    if (cc.verticesNeedUpdate) {
                        for (zc = 0; zc < kd; zc++) Jc = dd[zc], dc = 3 * zc, Lc[dc] = Jc.x, Lc[dc + 1] = Jc.y, Lc[dc + 2] = Jc.z;
                        k.bindBuffer(k.ARRAY_BUFFER, cc.__webglVertexBuffer);
                        k.bufferData(k.ARRAY_BUFFER, Lc, cd)
                    }
                    if (md) {
                        for (Ac = 0; Ac < ld; Ac++) Kc = ed[Ac], dc = 3 * Ac, Mc[dc] = Kc.r, Mc[dc + 1] = Kc.g, Mc[dc + 2] = Kc.b;
                        k.bindBuffer(k.ARRAY_BUFFER, cc.__webglColorBuffer);
                        k.bufferData(k.ARRAY_BUFFER, Mc, cd)
                    }
                }
                ga.verticesNeedUpdate = !1;
                ga.colorsNeedUpdate = !1
                ...
                ab = c(ub, gb);
                eb = ab.attributes && o(ab);
                if (ga.verticesNeedUpdate || ga.colorsNeedUpdate || eb) {
                    var Vb = ga,
                        $c = k.DYNAMIC_DRAW,
                        Bc = void 0,
                        Cc = void 0,
                        ...
                        Pc = Vb.__vertexArray,
                        Qc = Vb.__colorArray,
                        pd = Vb.colorsNeedUpdate,
                        ad = Vb.__webglCustomAttributesList,
                        Rc = void 0,
                        hd = void 0,
                        Qa = void 0,
                        qc = void 0,
                    ...
                    if (Vb.verticesNeedUpdate) {
                        for (Bc = 0; Bc < nd; Bc++) Nc = fd[Bc], Aa = 3 * Bc, Pc[Aa] = Nc.x, Pc[Aa + 1] = Nc.y, Pc[Aa + 2] = Nc.z;
                        k.bindBuffer(k.ARRAY_BUFFER, Vb.__webglVertexBuffer);
                        k.bufferData(k.ARRAY_BUFFER, Pc, $c)
                    }
                    if (pd) {
                        for (Cc = 0; Cc < od; Cc++) Oc = gd[Cc], Aa = 3 * Cc, Qc[Aa] = Oc.r, Qc[Aa + 1] = Oc.g, Qc[Aa + 2] = Oc.b;
                        k.bindBuffer(k.ARRAY_BUFFER, Vb.__webglColorBuffer);
                        k.bufferData(k.ARRAY_BUFFER, Qc, $c)
                    }
                    if (ad) {
                        Rc = 0;
                        for (hd = ad.length; Rc < hd; Rc++) if (va = ad[Rc], va.needsUpdate && (void 0 === va.boundTo || "vertices" === va.boundTo)) {
                            Aa = 0;
                            qc = va.value.length;
                            if (1 === va.size) for (Qa = 0; Qa < qc; Qa++) va.array[Qa] = va.value[Qa];
                            else if (2 === va.size) for (Qa = 0; Qa < qc; Qa++) cb = va.value[Qa], va.array[Aa] = cb.x, va.array[Aa + 1] = cb.y,
                            Aa += 2;
                            else if (3 === va.size) if ("c" === va.type) for (Qa = 0; Qa < qc; Qa++) cb = va.value[Qa], va.array[Aa] = cb.r, va.array[Aa + 1] = cb.g, va.array[Aa + 2] = cb.b, Aa += 3;
                            else for (Qa = 0; Qa < qc; Qa++) cb = va.value[Qa], va.array[Aa] = cb.x, va.array[Aa + 1] = cb.y, va.array[Aa + 2] = cb.z, Aa += 3;
                            else if (4 === va.size) for (Qa = 0; Qa < qc; Qa++) cb = va.value[Qa], va.array[Aa] = cb.x, va.array[Aa + 1] = cb.y, va.array[Aa + 2] = cb.z, va.array[Aa + 3] = cb.w, Aa += 4;
                            k.bindBuffer(k.ARRAY_BUFFER, va.buffer);
                            k.bufferData(k.ARRAY_BUFFER, va.array, $c)
                        }
                    }
                }
                ga.verticesNeedUpdate = !1;
                ga.colorsNeedUpdate = !1;
                ab.attributes && q(ab)
            } else ub instanceof THREE.ParticleSystem && (ga instanceof THREE.BufferGeometry ? ((ga.verticesNeedUpdate || ga.colorsNeedUpdate) && h(ga, k.DYNAMIC_DRAW, !ga.dynamic), ga.verticesNeedUpdate = !1, ga.colorsNeedUpdate = !1) : (ab = c(ub, gb), eb = ab.attributes && o(ab), (ga.verticesNeedUpdate || ga.colorsNeedUpdate || ub.sortParticles || eb) && g(ga, k.DYNAMIC_DRAW, ub), ga.verticesNeedUpdate = !1, ga.colorsNeedUpdate = !1, ab.attributes && q(ab)))
        }
    };
    this.initMaterial = function (a, b, c, d) {
        ...
        var p, q, s;
        e = p = q = s = o = 0;
        for (f = b.length; e < f; e++) g = b[e], g.onlyShadow || (g instanceof THREE.DirectionalLight && p++, g instanceof THREE.PointLight && q++, g instanceof THREE.SpotLight && s++, g instanceof THREE.HemisphereLight && o++);
        q + s + p + o <= ea ? e = p : (e = Math.ceil(ea * p / (q + p)), s = q = ea - e, o = e);
        f = q;
        g = s;
        h = o;
        o = p = 0;
        for (s = b.length; o < s; o++) q = b[o], q.castShadow && (q instanceof THREE.SpotLight && p++, q instanceof THREE.DirectionalLight && !q.shadowCascade && p++);
        m = p;
        ic && d && d.useVertexTexture ? l = 1024 : (b = k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS), b = Math.floor((b - 20) / 4), void 0 !== d && d instanceof THREE.SkinnedMesh && (b = Math.min(d.bones.length, b), b < d.bones.length && console.warn("WebGLRenderer: too many bones - " + d.bones.length + ", this GPU supports just " + b + " (try OpenGL instead of ANGLE)")), l = b);
        var r;
        a: {
            q = a.fragmentShader;
            s = a.vertexShader;
            ...
            var c = {
                ...
                skinning: a.skinning,
                maxBones: l,
                useVertexTexture: ic && d && d.useVertexTexture,
            ...
            n ? d.push(n) : (d.push(q), d.push(s));
            for (u in p) d.push(u), d.push(p[u]);
            for (t in c) d.push(t), d.push(c[t]);
            n = d.join();
            t = 0;
            for (u = qa.length; t < u; t++) if (d = qa[t], d.code === n) {
                d.usedTimes++;
                r = d.program;
                break a
            }
            t = [];
            for (v in p) u = p[v], !1 !== u && (u = "#define " + v + " " + u, t.push(u));
            u = t.join("\n");
            v = k.createProgram();
            t = ["precision " + K + " float;", u, hc ? "#define VERTEX_TEXTURES" :
            ...
            y = t;
            t = 0;
            for (u = y.length; t < u; t++) d = y[t], v.uniforms[d] = k.getUniformLocation(v, d);
            t = "position normal uv uv2 tangent color skinIndex skinWeight".split(" ");
            for (y = 0; y < c.maxMorphTargets; y++) t.push("morphTarget" + y);
            for (y = 0; y < c.maxMorphNormals; y++) t.push("morphNormal" + y);
            for (r in b) t.push(r);
            r = t;
            y = 0;
            for (t = r.length; y < t; y++) u = r[y], v.attributes[u] = k.getAttribLocation(v, u);
            v.id = la++;
            qa.push({
                program: v,
                code: n,
            ...
            Q.info.memory.programs = qa.length;
            r = v
        }
        a.program = r;
        ...
        a.skinning && (0 <= r.skinIndex && 0 <= r.skinWeight) && (k.enableVertexAttribArray(r.skinIndex), k.enableVertexAttribArray(r.skinWeight));
        if (a.attributes) for (j in a.attributes) void 0 !== r[j] && 0 <= r[j] && k.enableVertexAttribArray(r[j]);
        if (a.morphTargets) {
            a.numSupportedMorphTargets = 0;
            v = "morphTarget";
            for (j = 0; j < this.maxMorphTargets; j++) y = v + j, 0 <= r[y] && (k.enableVertexAttribArray(r[y]), a.numSupportedMorphTargets++)
        }
        if (a.morphNormals) {
    ...
    this.setMaterialFaces = function (a) {
        ...
        Ga !== b && (b ? k.disable(k.CULL_FACE) : k.enable(k.CULL_FACE), Ga = b);
        Pa !== a && (a ? k.frontFace(k.CW) : k.frontFace(k.CCW), Pa = a)
    };
    this.setDepthTest = function (a) {
        ib !== a && (a ? k.enable(k.DEPTH_TEST) : k.disable(k.DEPTH_TEST), ib = a)
    };
    this.setDepthWrite = function (a) {
        Ra !== a && (k.depthMask(a), Ra = a)
    };
    this.setBlending = function (a, b, c, d) {
        a !== Ia && (a === THREE.NoBlending ? k.disable(k.BLEND) : a === THREE.AdditiveBlending ? (k.enable(k.BLEND), k.blendEquation(k.FUNC_ADD), k.blendFunc(k.SRC_ALPHA, k.ONE)) : a === THREE.SubtractiveBlending ? (k.enable(k.BLEND), k.blendEquation(k.FUNC_ADD), k.blendFunc(k.ZERO, k.ONE_MINUS_SRC_COLOR)) : a === THREE.MultiplyBlending ? (k.enable(k.BLEND), k.blendEquation(k.FUNC_ADD), k.blendFunc(k.ZERO, k.SRC_COLOR)) : a === THREE.CustomBlending ? k.enable(k.BLEND) : (k.enable(k.BLEND), k.blendEquationSeparate(k.FUNC_ADD, k.FUNC_ADD), k.blendFuncSeparate(k.SRC_ALPHA, k.ONE_MINUS_SRC_ALPHA, k.ONE, k.ONE_MINUS_SRC_ALPHA)), Ia = a);
        if (a === THREE.CustomBlending) {
            if (b !== Ua && (k.blendEquation(E(b)), Ua = b), c !== na || d !== Va) k.blendFunc(E(c), E(d)), na = c, Va = d
        } else Va = na = Ua = null
    };
    this.setTexture = function (a, b) {
        if (a.needsUpdate) {
            a.__webglInit || (a.__webglInit = !0, a.__webglTexture = k.createTexture(), Q.info.memory.textures++);
            ...
            var c = a.image,
                ...
                f = E(a.type);
            G(k.TEXTURE_2D, a, d);
            if (a instanceof THREE.CompressedTexture) for (var f = a.mipmaps, g = 0, h = f.length; g < h; g++) c = f[g], k.compressedTexImage2D(k.TEXTURE_2D, g, e, c.width, c.height, 0, c.data);
            else a instanceof THREE.DataTexture ? k.texImage2D(k.TEXTURE_2D, 0, e, c.width, c.height, 0, e, f, c.data) : k.texImage2D(k.TEXTURE_2D, 0, e, e, f, a.image);
    ...
    this.setRenderTarget = function (a) {
        ...
        if (a && !a.__webglFramebuffer) {
            ...
            } else a.__webglFramebuffer = k.createFramebuffer(), a.__webglRenderbuffer = k.createRenderbuffer(), k.bindTexture(k.TEXTURE_2D, a.__webglTexture), G(k.TEXTURE_2D, a, c), k.texImage2D(k.TEXTURE_2D, 0, d, a.width, a.height, 0, d, e, null), d = k.TEXTURE_2D, k.bindFramebuffer(k.FRAMEBUFFER, a.__webglFramebuffer), k.framebufferTexture2D(k.FRAMEBUFFER, k.COLOR_ATTACHMENT0,
            d, a.__webglTexture, 0), H(a.__webglRenderbuffer, a), c && k.generateMipmap(k.TEXTURE_2D);
        ...
        a ? (b = b ? a.__webglFramebuffer[a.activeCubeFace] : a.__webglFramebuffer, c = a.width, a = a.height, e = d = 0) : (b = null, c = wa, a = wb, d = $a, e = Ja);
...
THREE.GeometryUtils = {
    merge: function (a, b) {
        ...
        for (o = j.length; p < o; p++) {
            ...
            h = 0;
            for (q = B.length; h < q; h++) t = B[h].clone(), d && d.multiplyVector3(t), r.vertexNormals.push(t);
            r.color.copy(g.color);
            h = 0;
            for (q = u.length; h < q; h++) t = u[h], r.vertexColors.push(t.clone());
            void 0 !== g.materialIndex && (h = f.materials[g.materialIndex], q = h.id, u = n[q], void 0 === u && (u = a.materials.length,
            n[q] = u, a.materials.push(h)), r.materialIndex = u);
        ...
        for (o = m.length; p < o; p++) {
            ...
            d = [];
            h = 0;
            for (q = c.length; h < q; h++) d.push(new THREE.UV(c[h].u, c[h].v));
            l.push(d)
        }
    },
    clone: function (a) {
    ...
    randomPointsInGeometry: function (a, b) {
        ...
        var d, e, f = a.faces,
            ...
            j = [],
            l, m, n, p;
        for (e = 0; e < h; e++) d = f[e], d instanceof THREE.Face3 ? (l = g[d.a], m = g[d.b], n = g[d.c], d._area = THREE.GeometryUtils.triangleArea(l, m, n)) : d instanceof THREE.Face4 && (l = g[d.a], m = g[d.b], n = g[d.c], p = g[d.d], d._area1 = THREE.GeometryUtils.triangleArea(l,
        m, p), d._area2 = THREE.GeometryUtils.triangleArea(m, n, p), d._area = d._area1 + d._area2), i += d._area, j[e] = i;
        d = [];
    ...
    normalizeUVs: function (a) {
        for (var a = a.faceVertexUvs[0], b = 0, c = a.length; b < c; b++) for (var d = a[b], e = 0, f = d.length; e < f; e++) if (1 !== d[e].u && (d[e].u -= Math.floor(d[e].u)), 1 !== d[e].v) d[e].v -= Math.floor(d[e].v)
    },
    triangulateQuads: function (a) {
        ...
        for (c = a.faces.length; b < c; b++) if (d = a.faces[b], d instanceof THREE.Face4) {
            ...
            f.push(m, n);
            d = 0;
            for (e = a.faceVertexUvs.length; d < e; d++) a.faceVertexUvs[d].length && (m = a.faceVertexUvs[d][b], i = m[1], j = m[2], l = m[3], m = [m[0].clone(), i.clone(), l.clone()], i = [i.clone(), j.clone(), l.clone()], h[d].push(m, i));
            d = 0;
    ...
    explode: function (a) {
        for (var b = [], c = 0, d = a.faces.length; c < d; c++) {
            ...
            if (f instanceof THREE.Face4) {
                ...
                f.c = e + 2;
                f.d = e + 3
            } else g = f.a, h = f.b, i = f.c, g = a.vertices[g], h = a.vertices[h], i = a.vertices[i],
    ...
    tessellate: function (a, b) {
        var c, d, e, f, g, h, i, j, l, m, n, p, o, q, r, t, B, u, s, z = [],
            A = [];
        c = 0;
        for (d = a.faceVertexUvs.length; c < d; c++) A[c] = [];
        c = 0;
        for (d = a.faces.length; c < d; c++) if (e = a.faces[c], e instanceof THREE.Face3) if (f = e.a, g = e.b, h = e.c, j = a.vertices[f], l = a.vertices[g], m = a.vertices[h], p = j.distanceTo(l), o = l.distanceTo(m), n = j.distanceTo(m), p > b || o > b || n > b) {
            i = a.vertices.length;
            u = e.clone();
            s = e.clone();
            p >= o && p >= n ? (j = j.clone(), j.lerpSelf(l, 0.5), u.a = f, u.b = i, u.c = h, s.a = i, s.b = g, s.c = h, 3 === e.vertexNormals.length && (f = e.vertexNormals[0].clone(), f.lerpSelf(e.vertexNormals[1], 0.5), u.vertexNormals[1].copy(f), s.vertexNormals[0].copy(f)), 3 === e.vertexColors.length && (f = e.vertexColors[0].clone(), f.lerpSelf(e.vertexColors[1], 0.5), u.vertexColors[1].copy(f), s.vertexColors[0].copy(f)), e = 0) : o >= p && o >= n ? (j = l.clone(), j.lerpSelf(m, 0.5), u.a = f, u.b = g, u.c = i, s.a = i, s.b = h, s.c = f, 3 === e.vertexNormals.length && (f = e.vertexNormals[1].clone(),
            ...
            a.vertices.push(j);
            f = 0;
            for (g = a.faceVertexUvs.length; f < g; f++) a.faceVertexUvs[f].length && (j = a.faceVertexUvs[f][c], s = j[0], h = j[1], u = j[2], 0 === e ? (l = s.clone(), l.lerpSelf(h, 0.5), j = [s.clone(), l.clone(), u.clone()], h = [l.clone(), h.clone(),
            u.clone()]) : 1 === e ? (l = h.clone(), l.lerpSelf(u, 0.5), j = [s.clone(), h.clone(), l.clone()], h = [l.clone(), u.clone(), s.clone()]) : (l = s.clone(), l.lerpSelf(u, 0.5), j = [s.clone(), h.clone(), l.clone()], h = [l.clone(), h.clone(), u.clone()]), A[f].push(j, h))
        } else {
            z.push(e);
            f = 0;
            for (g = a.faceVertexUvs.length; f < g; f++) A[f].push(a.faceVertexUvs[f][c])
        } else if (f = e.a, g = e.b, h = e.c, i = e.d, j = a.vertices[f], l = a.vertices[g], m = a.vertices[h], n = a.vertices[i], p = j.distanceTo(l), o = l.distanceTo(m), q = m.distanceTo(n), r = j.distanceTo(n), p > b || o > b || q > b || r > b) {
            t = a.vertices.length;
            B = a.vertices.length + 1;
            u = e.clone();
            s = e.clone();
            p >= o && p >= q && p >= r || q >= o && q >= p && q >= r ? (p = j.clone(), p.lerpSelf(l, 0.5), l = m.clone(), l.lerpSelf(n, 0.5), u.a = f, u.b = t, u.c = B, u.d = i, s.a = t, s.b = g, s.c = h, s.d = B, 4 === e.vertexNormals.length && (f = e.vertexNormals[0].clone(), f.lerpSelf(e.vertexNormals[1], 0.5), g = e.vertexNormals[2].clone(), g.lerpSelf(e.vertexNormals[3], 0.5), u.vertexNormals[1].copy(f), u.vertexNormals[2].copy(g), s.vertexNormals[0].copy(f), s.vertexNormals[3].copy(g)), 4 === e.vertexColors.length && (f = e.vertexColors[0].clone(), f.lerpSelf(e.vertexColors[1], 0.5), g = e.vertexColors[2].clone(), g.lerpSelf(e.vertexColors[3], 0.5), u.vertexColors[1].copy(f), u.vertexColors[2].copy(g), s.vertexColors[0].copy(f), s.vertexColors[3].copy(g)), e = 0) : (p = l.clone(), p.lerpSelf(m, 0.5), l = n.clone(), l.lerpSelf(j, 0.5), u.a = f, u.b = g, u.c = t, u.d = B, s.a = B, s.b = t, s.c = h, s.d = i, 4 === e.vertexNormals.length && (f = e.vertexNormals[1].clone(), f.lerpSelf(e.vertexNormals[2], 0.5), g = e.vertexNormals[3].clone(), g.lerpSelf(e.vertexNormals[0], 0.5),
            ...
            a.vertices.push(p, l);
            f = 0;
            for (g = a.faceVertexUvs.length; f < g; f++) a.faceVertexUvs[f].length && (j = a.faceVertexUvs[f][c], s = j[0],
            h = j[1], u = j[2], j = j[3], 0 === e ? (l = s.clone(), l.lerpSelf(h, 0.5), m = u.clone(), m.lerpSelf(j, 0.5), s = [s.clone(), l.clone(), m.clone(), j.clone()], h = [l.clone(), h.clone(), u.clone(), m.clone()]) : (l = h.clone(), l.lerpSelf(u, 0.5), m = j.clone(), m.lerpSelf(s, 0.5), s = [s.clone(), h.clone(), l.clone(), m.clone()], h = [m.clone(), l.clone(), u.clone(), j.clone()]), A[f].push(s, h))
        } else {
            z.push(e);
            f = 0;
            for (g = a.faceVertexUvs.length; f < g; f++) A[f].push(a.faceVertexUvs[f][c])
...
THREE.ImageUtils = {
    ...
    getNormalMap: function (a, b) {
        ...
        g.drawImage(a, 0, 0);
        for (var h = g.getImageData(0, 0, d, e).data, i = g.createImageData(d, e), j = i.data, l = 0; l < d; l++) for (var m = 0; m < e; m++) {
            var n = 0 > m - 1 ? 0 : m - 1,
                p = m + 1 > e - 1 ? e - 1 : m + 1,
                o = 0 > l - 1 ? 0 : l - 1,
                q = l + 1 > d - 1 ? d - 1 : l + 1,
                r = [],
                t = [0, 0, h[4 * (m * d + l)] / 255 * b];
            r.push([-1, 0, h[4 * (m * d + o)] / 255 * b]);
            r.push([-1, -1, h[4 * (n * d + o)] / 255 * b]);
            r.push([0, -1, h[4 * (n * d + l)] / 255 * b]);
            r.push([1, -1, h[4 * (n * d + q)] / 255 * b]);
            r.push([1, 0, h[4 * (m * d + q)] / 255 * b]);
            r.push([1, 1, h[4 * (p * d + q)] / 255 * b]);
            r.push([0, 1, h[4 * (p * d + l)] / 255 * b]);
            r.push([-1, 1, h[4 * (p * d + o)] / 255 * b]);
            n = [];
            o = r.length;
            for (p = 0; p < o; p++) {
                var q = r[p],
                ...
                n.push(c([q[1] * B[2] - q[2] * B[1], q[2] * B[0] - q[0] * B[2], q[0] * B[1] - q[1] * B[0]]))
            }
            r = [0, 0, 0];
...
THREE.FontUtils = {
    ...
    extractGlyphPoints: function (a, b, c, d, e) {
        var f = [],
            g, h, i, j, l, m, n, p, o, q, r, t = b.glyphs[a] || b.glyphs["?"];
        if (t) {
            if (t.o) {
                        ...
                        case "q":
                            ...
                            if (g = f[f.length - 1]) {
                                ...
                                for (h = this.divisions; g <= h; g++) {
                                    var B = g / h;
                                    THREE.Shape.Utils.b2(B, m, p, i);
                                    THREE.Shape.Utils.b2(B, n, o, l)
                                }
                            }
                            break;
                        case "b":
                            ...
                            if (g = f[f.length - 1]) {
                                ...
                                for (h = this.divisions; g <= h; g++) {
                                    B = g / h;
                                    THREE.Shape.Utils.b3(B, m, p, q, i);
                                    THREE.Shape.Utils.b3(B, n, o, r, l)
                                }
                            }
                    }
                }
...
THREE.FontUtils.generateShapes = function (a, b) {
    var b = b || {}, c = b.curveSegments !== void 0 ? b.curveSegments : 4,
        ...
        for (j = e - 1; e > 2;) {
            ...
            a: {
                ...
                var p = i,
                    ...
                    v = n[t[q]].x,
                    y = n[t[q]].y;
                if (1E-10 > (z - u) * (y - s) - (A - s) * (v - u)) n = false;
                else {
                    for (B = 0; B < r; B++) if (!(B == p || B == o || B == q)) {
                        var C = n[t[B]].x,
                            G = n[t[B]].y,
                            H = void 0,
                            J = void 0,
...
THREE.CurvePath.prototype.getBoundingBox = function () {
    ...
    var h, i, j, l, m = a[0] instanceof THREE.Vector3;
...
THREE.Path.prototype.getPoints = function (a, b) {
    ...
    for (e = this.actions.length; d < e; d++) {
        ...
        switch (g) {
            ...
            case THREE.PathActions.QUADRATIC_CURVE_TO:
                ...
                for (f = 1; f <= a; f++) {
                    q = f / a;
                    g = THREE.Shape.Utils.b2(q, p, m, h);
                    q = THREE.Shape.Utils.b2(q, o, n, i);
            ...
            case THREE.PathActions.BEZIER_CURVE_TO:
                ...
                for (f = 1; f <= a; f++) {
                    q = f / a;
                    g = THREE.Shape.Utils.b3(q, p, m, j, h);
                    q = THREE.Shape.Utils.b3(q, o, n, l, i);
    ...
    d = c[c.length - 1];
    Math.abs(d.x - c[0].x) < 1E-10 && Math.abs(d.y - c[0].y) < 1E-10 && c.splice(c.length - 1, 1);
    b && c.push(c[0]);
    return c
};
                ...
                if (this.JITCompile && f[a][e] !== void 0) if (d instanceof THREE.Bone) {
                    ...
                    if (b && c) {
                        if (c.time <= h) {
                            ...
                            } else if (!i) for (var n = l.length - 1; c.time < g && c.index !== n;) {
                                b = c;
                                c = l[b.index + 1]
                            }
                            m.prevKey = b;
...
THREE.CubeGeometry = function (a, b, c, d, e, f, g, h) {
    function i(a, b, c, g, h, i, l, m) {
        ...
        for (h = 0; h < p; h++) for (i = 0; i < o; i++) {
            a = new THREE.Face4(i + u * h + t, i + u * (h + 1) + t, i + 1 + u * (h + 1) + t, i + 1 + u * h + t);
            a.normal.copy(N);
            a.vertexNormals.push(N.clone(), N.clone(), N.clone(), N.clone());
            a.materialIndex = m;
            j.faces.push(a);
            j.faceVertexUvs[0].push([new THREE.UV(i / o, 1 - h / p), new THREE.UV(i / o, 1 - (h + 1) / p), new THREE.UV((i + 1) / o, 1 - (h + 1) / p), new THREE.UV((i + 1) / o, 1 - h / p)])
        }
    }
    THREE.Geometry.call(this);
    var j = this,
    ...
    this.sides.py && i("x", "z", 1, 1, a, c, m, o);
    this.sides.ny && i("x", "z", 1, -1, a, c, -m, t);
    this.sides.pz && i("x", "y", 1, -1, a, b, n, q);
    this.sides.nz && i("x", "y", -1, -1, a, b, -n, B);
    this.computeCentroids();
    this.mergeVertices()
};
...
THREE.CylinderGeometry = function (a, b, c, d, e, f) {
    ...
    for (i = 0; i <= e; i++) {
        ...
        for (h = 0; h <= d; h++) {
            var q = h / d,
                r = new THREE.Vector3;
            r.x = o * Math.sin(q * Math.PI * 2);
            r.y = -p * c + g;
            r.z = o * Math.cos(q * Math.PI * 2);
            this.vertices.push(r);
            m.push(this.vertices.length - 1);
            n.push(new THREE.UV(q, 1 - p))
        }
        j.push(m);
        l.push(n)
    }
    ...
    for (h = 0; h < d; h++) {
        ...
        for (i = 0; i < e; i++) {
            var p = j[i][h],
                ...
                v = l[i + 1][h + 1].clone(),
                y = l[i][h + 1].clone();
            this.faces.push(new THREE.Face4(p, o, q, r, [t, B, u, s]));
            this.faceVertexUvs[0].push([z, A, v, y])
        }
    }
    if (!f && a > 0) {
        ...
        for (h = 0; h < d; h++) {
            ...
            this.faces.push(new THREE.Face3(p, o, q, [t, B, u]));
            this.faceVertexUvs[0].push([z, A, v])
        }
    }
    if (!f && b > 0) {
        this.vertices.push(new THREE.Vector3(0, -g, 0));
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
        ...
        for (N = c.length; --N >= 0;) {
            ...
            for (var g = 0, h = n + l * 2, g = 0; g < h; g++) {
                var i = R * g,
                    ...
                    o = o + H,
                    j = j + H;
                G.faces.push(new THREE.Face4(m, i, o, j, null, null, t));
                m = B.generateSideWallUV(G, a, p, b, m, i, o, j, q, r, s, u);
    ...
    function g(c, d, e, f) {
        ...
        d = d + H;
        e = e + H;
        G.faces.push(new THREE.Face3(c, d, e, null, null, r));
        c = f ? B.generateBottomUV(G, a, b, c, d, e) : B.generateTopUV(G, a, b, c, d, e);
    ...
    var h = b.amount !== void 0 ? b.amount : 100,
        ...
        r = b.material,
        t = b.extrudeMaterial,
        B = b.UVGenerator !== void 0 ? b.UVGenerator : THREE.ExtrudeGeometry.WorldUVGenerator,
        u, s, z, A;
    if (p) {
    ...
    var v, y, C, G = this,
        ...
        J = p.shape,
        p = p.holes,
        E = !THREE.Shape.Utils.isClockWise(J);
    if (E) {
        J = J.reverse();
        y = 0;
        for (C = p.length; y < C; y++) {
            v = p[y];
            THREE.Shape.Utils.isClockWise(v) && (p[y] = v.reverse())
        }
        E = false
    }
    var M = THREE.Shape.Utils.triangulateShape(J, p),
        E = J;
    y = 0;
    for (C = p.length; y < C; y++) {
        v = p[y];
    ...
    var K, F, I, L, R = J.length,
        $ = M.length,
        Y = [],
        N = 0,
        ea = E.length;
    K = ea - 1;
    for (F = N + 1; N < ea; N++, K++, F++) {
        K === ea && (K = 0);
        F === ea && (F = 0);
        Y[N] = d(E[N], E[K], E[F])
    }
    ...
    for (K = 0; K < l; K++) {
        v = K / l;
        I = i * (1 - v);
        F = j * Math.sin(v * Math.PI / 2);
        N = 0;
        for (ea = E.length; N < ea; N++) {
            L = c(E[N], Y[N], F);
            f(L.x, L.y, -I)
        }
        y = 0;
    ...
    for (N = 0; N < R; N++) {
        ...
        la[N], F) : J[N];
        if (q) {
            z.copy(u.normals[0]).multiplyScalar(L.x);
            s.copy(u.binormals[0]).multiplyScalar(L.y);
            A.copy(o[0]).addSelf(z).addSelf(s);
            f(A.x, A.y, A.z)
        } else f(L.x, L.y, 0)
    }
    for (v = 1; v <= n; v++) for (N = 0; N < R; N++) {
        L = m ? c(J[N], la[N], F) : J[N];
        if (q) {
            z.copy(u.normals[v]).multiplyScalar(L.x);
            s.copy(u.binormals[v]).multiplyScalar(L.y);
            A.copy(o[v]).addSelf(z).addSelf(s);
            f(A.x, A.y, A.z)
        } else f(L.x, L.y, h / n * v)
    }
    for (K = l - 1; K >= 0; K--) {
        v = K / l;
        I = i * (1 - v);
        ...
        for (C = p.length; y < C; y++) {
            ...
            for (ea = v.length; N < ea; N++) {
                L = c(v[N], qa[N], F);
                q ? f(L.x, L.y + o[n - 1].y, o[n - 1].x + I) : f(L.x, L.y, h + I)
            }
        }
    }
    if (m) {
        ...
        for (N = 0; N < $; N++) {
            h = M[N];
            g(h[0] + R * n, h[1] + R * n, h[2] + R * n, false)
        }
    }
    h = 0;
    e(E, h);
...
THREE.ExtrudeGeometry.WorldUVGenerator = {
    ...
    generateSideWallUV: function (a, b, c, d, e, f, g, h) {
        var b = a.vertices[e].x,
            ...
            n = a.vertices[h].y,
            a = a.vertices[h].z;
        return Math.abs(c - i) < 0.01 ? [new THREE.UV(b, 1 - e), new THREE.UV(d, 1 - f), new THREE.UV(j, 1 - g), new THREE.UV(m, 1 - a)] : [new THREE.UV(c, 1 - e), new THREE.UV(i, 1 - f), new THREE.UV(l, 1 - g), new THREE.UV(n, 1 - a)]
    }
};
...
THREE.ShapeGeometry.prototype.addShape = function (a, b) {
    b === void 0 && (b = {});
    var c = b.material,
        d = b.UVGenerator === void 0 ? THREE.ExtrudeGeometry.WorldUVGenerator : b.UVGenerator,
    ...
    if (!THREE.Shape.Utils.isClockWise(i)) {
        ...
        for (f = j.length; e < f; e++) {
            g = j[e];
            THREE.Shape.Utils.isClockWise(g) && (j[e] = g.reverse())
        }
    }
...
THREE.PlaneGeometry = function (a, b, c, d) {
    THREE.Geometry.call(this);
    for (var e = a / 2, f = b / 2, c = c || 1, d = d || 1, g = c + 1, h = d + 1, i = a / c, j = b / d, l = new THREE.Vector3(0, 0, 1), a = 0; a < h; a++) for (b = 0; b < g; b++) this.vertices.push(new THREE.Vector3(b * i - e, -(a * j - f), 0));
    for (a = 0; a < d; a++) for (b = 0; b < c; b++) {
        ...
        this.faces.push(e);
        this.faceVertexUvs[0].push([new THREE.UV(b / c, 1 - a / d), new THREE.UV(b / c, 1 - (a + 1) / d), new THREE.UV((b + 1) / c, 1 - (a + 1) / d), new THREE.UV((b + 1) / c, 1 - a / d)])
    }
    this.computeCentroids()
};
...
THREE.SphereGeometry = function (a, b, c, d, e, f, g) {
    ...
    for (i = 0; i <= c; i++) {
        ...
        for (h = 0; h <= b; h++) {
            var p = h / b,
                o = i / c,
                q = new THREE.Vector3;
            q.x = -a * Math.cos(d + p * e) * Math.sin(f + o * g);
            q.y = a * Math.cos(f + o * g);
            q.z = a * Math.sin(d + p * e) * Math.sin(f + o * g);
    ...
    for (i = 0; i < c; i++) for (h = 0; h < b; h++) {
        var d = j[i][h + 1],
            ...
            o = this.vertices[g].clone().normalize(),
            q = l[i][h + 1].clone(),
            r = l[i][h].clone(),
            t = l[i + 1][h].clone(),
            B = l[i + 1][h + 1].clone();
        if (Math.abs(this.vertices[d].y) == a) {
            this.faces.push(new THREE.Face3(d, f, g, [m, p, o]));
            this.faceVertexUvs[0].push([q, t, B])
        } else if (Math.abs(this.vertices[f].y) == a) {
            this.faces.push(new THREE.Face3(d, e, f, [m, n, p]));
            this.faceVertexUvs[0].push([q, r, t])
        } else {
            this.faces.push(new THREE.Face4(d, e, f, g, [m, n, p, o]));
            this.faceVertexUvs[0].push([q, r, t, B])
        }
    }
    this.computeCentroids();
    this.computeFaceNormals();
...
THREE.TorusKnotGeometry = function (a, b, c, d, e, f, g) {
    ...
    for (a = 0; a < this.radialSegments; ++a) {
        ...
        for (b = 0; b < this.tubularSegments; ++b) {
            var i = a / this.radialSegments * 2 * this.p * Math.PI,
                g = b / this.tubularSegments * 2 * Math.PI,
    ...
    for (a = 0; a < this.radialSegments; ++a) for (b = 0; b < this.tubularSegments; ++b) {
        var e = (a + 1) % this.radialSegments,
            ...
            i = new THREE.UV((a + 1) / this.radialSegments, b / this.tubularSegments),
...
THREE.TubeGeometry = function (a, b, c, d, e, f) {
    ...
    var g, h, f = this.segments + 1,
        ...
        n, p, o, b = new THREE.TubeGeometry.FrenetFrames(a, b, e);
    n = b.tangents;
    p = b.normals;
    o = b.binormals;
    this.tangents = n;
    ...
    for (b = 0; b < f; b++) {
        ...
        for (d = 0; d < this.radiusSegments; d++) {
            i = d / this.radiusSegments * 2 * Math.PI;
    ...
    for (b = 0; b < this.segments; b++) for (d = 0; d < this.radiusSegments; d++) {
        ...
        o = new THREE.UV((b + 1) / this.segments, (d + 1) / this.radiusSegments);
...
THREE.ConvexGeometry = function (a) {
    ...
    for (var c = [
        ...
        var e = d,
            f = a[e].clone(),
            g = f.length();
        f.x = f.x + g * (Math.random() - 0.5) * 2E-6;
        f.y = f.y + g * (Math.random() - 0.5) * 2E-6;
        f.z = f.z + g * (Math.random() - 0.5) * 2E-6;
...
THREE.GeometryUtils.computeEdgeFaces = function (a) {
    ...
    var c, d, e, f, g = {}, h = THREE.GeometryUtils.orderedKey;
    c = 0;
...
THREE.SubdivisionModifier.prototype.smooth = function (a) {
    function b() {
        l.debug && (console && console.assert) && console.assert.apply(console, arguments)
    }
    function c() {
    ...
    function e(a, b, d, e, g, h, m) {
        ...
        if (l.supportUVs) {
            ...
            g[0] ? g[1] ? g[2] ? g[3] ? j.push(g) : c("d :( ", e + ":" + m) : c("c :( ", d + ":" + m) : c("b :( ", b + ":" + m) : c("a :( ", a + ":" + m)
        }
    }
    function f(a, b) {
        var e = a + ":" + b,
            f = u[e];
        if (!f) {
            a >= q && a < q + o.length ? c("face pt") : c("edge pt");
    ...
    function g(a, b, c) {
        var e = a + ":" + b;
        e in u ? d("dup vertexNo", a, "oldFaceNo", b, "value",
        c, "key", e, u[e]) : u[e] = c
    }
    var h = [],
        i = [],
        ...
        h = p.concat(),
        r = [],
        t = {}, B = {}, u = {}, s, z, A, v, y, C = a.faceVertexUvs[0],
        G;
    c("originalFaces, uvs, originalVerticesLength", o.length, C.length, q);
    if (l.supportUVs) {
        s = 0;
        for (z = C.length; s < z; s++) {
            A = 0;
            for (v = C[s].length; A < v; A++) {
                G = o[s]["abcd".charAt(A)];
                g(G, s, C[s][A])
            }
        }
    }
    if (C.length == 0) l.supportUVs = false;
    s = 0;
    for (var H in u) s++;
    if (!s) {
        l.supportUVs = false;
    ...
    for (z = o.length; s < z; s++) {
        ...
        if (l.supportUVs) {
            ...
            if (y instanceof THREE.Face3) {
                v.u = f(y.a, s).u + f(y.b, s).u + f(y.c, s).u;
                v.v = f(y.a, s).v + f(y.b, s).v + f(y.c, s).v;
                v.u = v.u / 3;
                v.v = v.v / 3
            } else if (y instanceof THREE.Face4) {
                v.u = f(y.a, s).u + f(y.b, s).u + f(y.c, s).u + f(y.d, s).u;
                v.v = f(y.a, s).v + f(y.b, s).v + f(y.c, s).v + f(y.d, s).v;
                v.u = v.u / 4;
                v.v = v.v / 4
            }
            g(q + s, "", v)
    ...
    for (s in n) {
        ...
        E = E[1];
        v = new THREE.Vector3;
        b(G.length > 0, "an edge without faces?!");
        if (G.length == 1) {
            v.addSelf(p[M]);
            v.addSelf(p[E]);
        ...
        if (l.supportUVs) {
            ...
            g(t[s], y, v);
            if (G.length >= 2) {
                b(G.length == 2, "did we plan for more than 2 edges?");
                v = new THREE.UV;
                v.u = f(M, J).u + f(E, J).u;
                v.v = f(M, J).v + f(E, J).v;
                v.u = v.u / 2;
    ...
    for (z = r.length; s < z; s++) {
        ...
        if (y instanceof THREE.Face3) {
            ...
            E = m(y.b, y.c);
            I = m(y.c, y.a);
            e(G, t[M], y.b, t[E], y, v, s);
            e(G, t[E], y.c, t[I], y, J, s);
            e(G, t[I], y.a, t[M], y, K, s)
        } else if (y instanceof THREE.Face4) {
            M = m(y.a, y.b);
            E = m(y.b, y.c);
            I = m(y.c, y.d);
            L = m(y.d, y.a);
            e(G, t[M], y.b, t[E], y, F, s);
            e(G, t[E], y.c, t[I], y, R, s);
            e(G, t[I], y.d, t[L], y, $, s);
            e(G, t[L], y.a, t[M], y, Y, s)
        } else c("face should be a face!", y)
    }
    t = new THREE.Vector3;
    y = new THREE.Vector3;
    s = 0;
    for (z = p.length; s < z; s++) if (H[s] !== void 0) {
        t.set(0, 0, 0);
        y.set(0, 0, 0);
        ...
        M = H[s].length;
        v = G != M;
        for (A = 0; A < M; A++) B[m(H[s][A][0], H[s][A][1])] && J++;
        t.divideScalar(G);
        J = 0;
        if (v) {
            for (A = 0; A < M; A++) {
                G = H[s][A];
                if (K = n[m(G[0], G[1])].length == 1) {
                    G = p[G[0]].clone().addSelf(p[G[1]]).divideScalar(2);
                    y.addSelf(G);
                    J++
                }
            }
            y.divideScalar(4);
            b(J == 2, "should have only 2 boundary edges")
        } else {
            for (A = 0; A < M; A++) {
                G = H[s][A];
                G = p[G[0]].clone().addSelf(p[G[1]]).divideScalar(2);
        ...
        if (v) {
            ...
            E.multiplyScalar(M - 3);
            E.addSelf(t);
            E.addSelf(y.multiplyScalar(2));
            E.divideScalar(M)
        }
        h[s] = E
    }
...
THREE.LensFlarePlugin = function () {
    ...
    this.render = function (a, d, e, t) {
        ...
        if (B) {
            ...
            b.uniform1i(H.occlusionMap, 0);
            b.uniform1i(H.map,
            1);
            b.bindBuffer(b.ARRAY_BUFFER, f);
            b.vertexAttribPointer(v.vertex, 2, b.FLOAT, false, 16, 0);
            ...
            for (J = 0; J < B; J++) {
                ...
                y.set(v * s, v);
                K = a[J];
                u.set(K.matrixWorld.elements[12], K.matrixWorld.elements[13], K.matrixWorld.elements[14]);
                d.matrixWorldInverse.multiplyVector3(u);
                d.projectionMatrix.multiplyVector3(u);
                C.copy(u);
                G.x = C.x * z + z;
                G.y = C.y * A + A;
                if (j || G.x > 0 && G.x < e && G.y > 0 && G.y < t) {
                    b.activeTexture(b.TEXTURE1);
                    b.bindTexture(b.TEXTURE_2D, h);
                    b.copyTexImage2D(b.TEXTURE_2D, 0, b.RGB, G.x - 8, G.y - 8, 16, 16, 0);
                    b.uniform1i(H.renderType, 0);
                    b.uniform2f(H.scale, y.x, y.y);
                    b.uniform3f(H.screenPosition, C.x, C.y, C.z);
                    b.disable(b.BLEND);
                    ...
                    b.uniform1i(H.renderType, 1);
                    b.disable(b.DEPTH_TEST);
                    b.activeTexture(b.TEXTURE1);
                    b.bindTexture(b.TEXTURE_2D, h);
                    b.drawElements(b.TRIANGLES, 6, b.UNSIGNED_SHORT, 0);
                    K.positionScreen.copy(C);
                    K.customUpdateCallback ? K.customUpdateCallback(K) : K.updateLensFlares();
                    b.uniform1i(H.renderType, 2);
                    b.enable(b.BLEND);
                    E = 0;
                    for (M = K.lensFlares.length; E < M; E++) {
                        F = K.lensFlares[E];
                        if (F.opacity > 0.001 && F.scale > 0.001) {
                            ...
                            b.uniform3f(H.screenPosition, C.x, C.y, C.z);
                            b.uniform2f(H.scale, y.x, y.y);
                            b.uniform1f(H.rotation, F.rotation);
                            b.uniform1f(H.opacity, F.opacity);
                            b.uniform3f(H.color, F.color.r, F.color.g, F.color.b);
...
THREE.ShadowMapPlugin = function () {
    ...
    this.update = function (l, m) {
        ...
        for (p = l.__lights.length; n < p; n++) {
            o = l.__lights[n];
            if (o.castShadow) if (o instanceof THREE.DirectionalLight && o.shadowCascade) for (r = 0; r < o.shadowCascadeCount; r++) {
                var A;
                if (o.shadowCascadeArray[r]) A = o.shadowCascadeArray[r];
                else {
                    s = o;
                    B = r;
                    ...
                    A.onlyShadow = true;
                    A.castShadow = true;
                    A.shadowCameraNear = s.shadowCameraNear;
                    A.shadowCameraFar = s.shadowCameraFar;
                    A.shadowCameraLeft = s.shadowCameraLeft;
                    A.shadowCameraRight = s.shadowCameraRight;
                    A.shadowCameraBottom = s.shadowCameraBottom;
                    A.shadowCameraTop = s.shadowCameraTop;
                    A.shadowCameraVisible = s.shadowCameraVisible;
                    A.shadowDarkness = s.shadowDarkness;
                    A.shadowBias = s.shadowCascadeBias[B];
                    A.shadowMapWidth = s.shadowCascadeWidth[B];
                    A.shadowMapHeight = s.shadowCascadeHeight[B];
                    A.pointsWorld = [];
                    A.pointsFrustum = [];
                    u = A.pointsWorld;
                    t = A.pointsFrustum;
                    for (var v = 0; v < 8; v++) {
                        ...
                        t[v] = new THREE.Vector3
                    }
                    u = s.shadowCascadeNearZ[B];
                    ...
                    t.position = o.shadowCascadeOffset;
                    t.add(A);
                    t.add(A.target);
                    m.add(t);
                    o.shadowCascadeArray[r] = A;
                    console.log("Created virtualLight", A)
                }
                B = o;
                u = r;
                s = B.shadowCascadeArray[u];
                s.position.copy(B.position);
                s.target.position.copy(B.target.position);
                s.lookAt(s.target);
                s.shadowCameraVisible = B.shadowCameraVisible;
                s.shadowDarkness = B.shadowDarkness;
                s.shadowBias = B.shadowCascadeBias[u];
                t = B.shadowCascadeNearZ[u];
                B = B.shadowCascadeFarZ[u];
                s = s.pointsFrustum;
                s[0].z = t;
                s[1].z = t;
                s[2].z = t;
        ...
        for (p = z.length; n < p; n++) {
            o = z[n];
            if (!o.shadowMap) {
                o.shadowMap = new THREE.WebGLRenderTarget(o.shadowMapWidth, o.shadowMapHeight, {
                    minFilter: THREE.LinearFilter,
                    magFilter: THREE.LinearFilter,
                    format: THREE.RGBAFormat
                });
                o.shadowMapSize = new THREE.Vector2(o.shadowMapWidth, o.shadowMapHeight);
                o.shadowMatrix = new THREE.Matrix4
            }
            if (!o.shadowCamera) {
                if (o instanceof
                THREE.SpotLight) o.shadowCamera = new THREE.PerspectiveCamera(o.shadowCameraFov, o.shadowMapWidth / o.shadowMapHeight, o.shadowCameraNear, o.shadowCameraFar);
                else if (o instanceof THREE.DirectionalLight) o.shadowCamera = new THREE.OrthographicCamera(o.shadowCameraLeft, o.shadowCameraRight, o.shadowCameraTop, o.shadowCameraBottom, o.shadowCameraNear, o.shadowCameraFar);
                else {
            ...
            if (o.shadowCameraVisible && !o.cameraHelper) {
            ...
            if (o.isVirtual && A.originalCamera == m) {
                ...
                for (B = 0; B < 8; B++) {
                    ...
                    q.matrixWorldInverse.multiplyVector3(u);
                    if (u.x < i.x) i.x = u.x;
                    if (u.x > j.x) j.x = u.x;
                    if (u.y < i.y) i.y = u.y;
                    if (u.y > j.y) j.y = u.y;
            ...
            t = o.shadowMatrix;
            r = o.shadowCamera;
            r.position.copy(o.matrixWorld.getPosition());
            r.lookAt(o.target.matrixWorld.getPosition());
            r.updateMatrixWorld();
            r.matrixWorldInverse.getInverse(r.matrixWorld);
            if (o.cameraHelper) o.cameraHelper.visible = o.shadowCameraVisible;
            ...
            s = l.__webglObjects;
            o = 0;
            for (q = s.length; o < q; o++) {
                B = s[o];
                t = B.object;
                B.render = false;
                if (t.visible && t.castShadow && (!(t instanceof THREE.Mesh) || !t.frustumCulled || g.contains(t))) {
                    t._modelViewMatrix.multiply(r.matrixWorldInverse, t.matrixWorld);
                    B.render = true
                }
            }
            o = 0;
            for (q = s.length; o < q; o++) {
                ...
                if (B.render) {
                    t = B.object;
                    B = B.buffer;
                    v = t.material instanceof THREE.MeshFaceMaterial ? t.geometry.materials[0] : t.material;
                    u = t.geometry.morphTargets.length > 0 && v.morphTargets;
                    v = t instanceof THREE.SkinnedMesh && v.skinning;
                    u = t.customDepthMaterial ? t.customDepthMaterial : v ? u ? f : e : u ? d : c;
                    B instanceof THREE.BufferGeometry ? b.renderBufferDirect(r, l.__lights, null, u, B, t) : b.renderBuffer(r, l.__lights,
                    null, u, B, t)
                }
            }
...
THREE.SpritePlugin = function () {
    ...
    this.render = function (d, e, p, o) {
        ...
        if (q) {
            ...
            b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,
            g);
            b.uniformMatrix4fv(t.projectionMatrix, false, e._projectionMatrixArray);
            b.activeTexture(b.TEXTURE0);
            b.uniform1i(t.map, 0);
            for (var z, A = [], r = 0; r < q; r++) {
                z = d[r];
                if (z.visible && z.opacity !== 0) if (z.useScreenCoordinates) z.z = -z.position.z;
                else {
                    z._modelViewMatrix.multiply(e.matrixWorldInverse, z.matrixWorld);
                    z.z = -z._modelViewMatrix.elements[14]
                }
            }
            d.sort(a);
            for (r = 0; r < q; r++) {
                z = d[r];
                if (z.visible && z.opacity !== 0 && z.map && z.map.image && z.map.image.width) {
                    if (z.useScreenCoordinates) {
                        b.uniform1i(t.useScreenCoordinates, 1);
                        b.uniform3f(t.screenPosition, (z.position.x - p) / p, (u - z.position.y) / u, Math.max(0, Math.min(1, z.position.z)))
                    } else {
                        b.uniform1i(t.useScreenCoordinates, 0);
                        b.uniform1i(t.affectedByDistance, z.affectedByDistance ? 1 : 0);
                        b.uniformMatrix4fv(t.modelViewMatrix, false, z._modelViewMatrix.elements)
                    }
                    e = z.map.image.width / (z.scaleByViewport ? o : 1);
                    A[0] = e * B * z.scale.x;
                    A[1] = e * z.scale.y;
                    b.uniform2f(t.uvScale, z.uvScale.x, z.uvScale.y);
                    b.uniform2f(t.uvOffset, z.uvOffset.x, z.uvOffset.y);
                    b.uniform2f(t.alignment, z.alignment.x, z.alignment.y);
                    b.uniform1f(t.opacity, z.opacity);
                    b.uniform3f(t.color, z.color.r, z.color.g, z.color.b);
                    b.uniform1f(t.rotation, z.rotation);
                    b.uniform2fv(t.scale, A);
                    if (z.mergeWith3D && !s) {
                        b.enable(b.DEPTH_TEST);
                        s = true
                    } else if (!z.mergeWith3D && s) {
                        b.disable(b.DEPTH_TEST);
                        s = false
                    }
    ...
    this.update = function (g, h) {
        ...
        for (j = p.length; i < j; i++) {
            ...
            if (l.render) {
                n = l.object;
                l = l.buffer;
                n.material && b.setMaterialFaces(n.material);
                m = n.customDepthMaterial ? n.customDepthMaterial : n.geometry.morphTargets.length ? d : c;
                l instanceof THREE.BufferGeometry ? b.renderBufferDirect(h, g.__lights, null, m, l, n) : b.renderBuffer(h, g.__lights, null, m, l, n)
            }
        }
